...
TEST_F(TestDataType, DataType) {
    ...
    UT_LOG() << "Testing FieldData";
    {
        ...
        std::string WKB_LineString =
            "0102000000030000000000000000000000000000000"
        ...
        std::string WKB_Polygon =
            "01030000000100000005000000000000000000000000000000"
        ...
        UT_EXPECT_TRUE(FieldData::Spatial(
        ...
        UT_EXPECT_TRUE(
            FieldData::Spatial(Spatial<Wgs84>(SRID::WGS84, SpatialType::POINT, 0, WKB_Point))
                .AsWgsSpatial() == Spatial<Wgs84>(SRID::WGS84, SpatialType::POINT, 0, WKB_Point));
        UT_EXPECT_TRUE(FieldData::Spatial(
                           Spatial<Wgs84>(SRID::WGS84, SpatialType::LINESTRING, 0, WKB_LineString))
                           .AsWgsSpatial() ==
                       Spatial<Wgs84>(SRID::WGS84, SpatialType::LINESTRING, 0, WKB_LineString));
        ...
        UT_EXPECT_EQ(
            FieldData::Spatial(Spatial<Wgs84>(SRID::WGS84, SpatialType::POINT, 0, WKB_Point))
                .ToString(),
            EWKB_Point);
        UT_EXPECT_EQ(FieldData::Spatial(
                         Spatial<Wgs84>(SRID::WGS84, SpatialType::LINESTRING, 0, WKB_LineString))
                         .ToString(),
                     EWKB_LineString);
        UT_EXPECT_EQ(
        ...
        UT_EXPECT_EQ(FieldData::LineString(LineString<Wgs84>(EWKB_LineString)).ToString(),
                     EWKB_LineString);
        ...
        UT_EXPECT_TRUE(FieldData::Spatial(Spatial<Wgs84>(SRID::WGS84, SpatialType::LINESTRING, 0,
                                                         WKB_LineString)) ==
                       FieldData::Spatial(Spatial<Wgs84>(SRID::WGS84, SpatialType::LINESTRING, 0,
                                                         WKB_LineString)));
