      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            "developer-manual/client-tools/bolt-client",
            "developer-manual/client-tools/bolt-console-client",
          ],
        },
        {
          type: "category",
          ...
          items: [
            {
              ...
              label: "查询语句",
              items: [
                "developer-manual/interface/query/cypher",
                {
                  type: "category",
                  label: "GQL",
                  items: [
                    "developer-manual/interface/query/gql/intro",
                    {
                      type: "category",
                      label: "GQL子句",
                      items: [
                        "developer-manual/interface/query/gql/clauses/match",
                        "developer-manual/interface/query/gql/clauses/optional_match",
                        "developer-manual/interface/query/gql/clauses/return",
                        "developer-manual/interface/query/gql/clauses/next",
                        "developer-manual/interface/query/gql/clauses/where",
                        "developer-manual/interface/query/gql/clauses/orderby",
                        "developer-manual/interface/query/gql/clauses/skip",
                        "developer-manual/interface/query/gql/clauses/limit",
                      ],
                    },
                  ],
                },
            ...
            },
            {
              ...
              label: "网络协议",
              items: [
                "developer-manual/interface/protocol/restful-api-legacy",
            ...
            },
            {
              ...
              items: [
                ...
                "developer-manual/interface/learn/heterogeneous_graph",
              ],
            },
          ],
        },
        ...
        },
        {
          ...
          items: [
            ...
            "developer-manual/other/reset_admin_password",
          ],
        },
      ],
    },
