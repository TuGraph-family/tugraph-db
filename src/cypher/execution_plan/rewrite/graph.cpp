...
namespace rewrite_cypher{
    ...
    void Graph::AddEdge(size_t id,size_t source_id, size_t target_id,std::set<int> labels,parser::LinkDirection direction){
        ...
        if(direction==parser::LinkDirection::LEFT_TO_RIGHT){
            ...
            m_edges.push_back(Edge(id,target_id,source_id,labels,parser::LinkDirection::RIGHT_TO_LEFT));
