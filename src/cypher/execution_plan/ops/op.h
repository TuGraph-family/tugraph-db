...
inline std::string ToString(OpBase::OpResult opt) {
    switch (opt) {
        case OpBase::OpResult::OP_DEPLETED: return "OP_DEPLETED";
        case OpBase::OpResult::OP_REFRESH: return "OP_REFRESH";
        case OpBase::OpResult::OP_OK: return "OP_OK";
        case OpBase::OpResult::OP_ERR: return "OP_ERR";
        default: return "unkown OpResult type";
    }
}
