...
class PatternGraph {
 ...
 public:
    ...
    RelpID AddRelationship(const std::set<std::string> &types, geax::frontend::Edge* ast_node_, NodeID lhs, NodeID rhs,
    ...
    RelpID AddRelationship(Relationship *relp) {
        return AddRelationship(relp->Types(), relp->ast_node_,relp->Lhs(), relp->Rhs(), relp->direction_,
