...
class BuiltinProcedureV2 {
 ...
 public:
    ...
    static void DbRebuildFullTextIndex(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                       const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbAddEdgeConstraints(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                     const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    static void DbClearEdgeConstraints(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                       const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbmsSecurityCreateUser(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                       const VEC_STR_V2 &yield_items, std::vector<Record> *records);

    static void DbmsSecurityDeleteUser(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                       const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbmsGraphListUserGraphs(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                        const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbmsListBackupLogFiles(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                       const VEC_STR_V2 &yield_items, std::vector<Record> *records);

    static void DbmsSecurityListRoles(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                      const VEC_STR_V2 &yield_items, std::vector<Record> *records);

    static void DbmsSecurityCreateRole(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                       const VEC_STR_V2 &yield_items, std::vector<Record> *records);

    static void DbmsSecurityDeleteRole(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                       const VEC_STR_V2 &yield_items, std::vector<Record> *records);

    static void DbmsSecurityGetUserInfo(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                        const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbmsSecurityGetRoleInfo(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                        const VEC_STR_V2 &yield_items, std::vector<Record> *records);

    static void DbmsSecurityDisableRole(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                        const VEC_STR_V2 &yield_items, std::vector<Record> *records);

    static void DbmsSecurityModRoleDesc(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                        const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbmsSecurityDisableUser(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                        const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbmsSecuritySetUserDesc(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                        const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbmsSecurityAddUserRoles(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                         const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbPluginListUserPlugins(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                        const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbImportorDataImportor(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                       const VEC_STR_V2 &yield_items, std::vector<Record> *records);

    static void DbImportorFullImportor(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                       const VEC_STR_V2 &yield_items, std::vector<Record> *records);
    ...
    static void DbImportorSchemaImportor(RTContext *ctx, const Record *record, const VEC_EXPR_V2 &args,
                                         const VEC_STR_V2 &yield_items, std::vector<Record> *records);
...
static std::vector<ProcedureV2> global_procedures_v2 = {
    ...
    ProcedureV2("db.warmup", BuiltinProcedureV2::DbWarmUp, ProcedureV2::SIG_SPEC{},
              ProcedureV2::SIG_SPEC{{"time_used", {0, lgraph_api::LGraphType::STRING}}}, true, true),
    ...
    ProcedureV2("db.fullTextIndexes", BuiltinProcedureV2::DbFullTextIndexes, ProcedureV2::SIG_SPEC{},
              ProcedureV2::SIG_SPEC{{"is_vertex", {0, lgraph_api::LGraphType::BOOLEAN}},
    ...
    ProcedureV2("dbms.meta.countDetail", BuiltinProcedureV2::DbmsMetaCountDetail, ProcedureV2::SIG_SPEC{},
              ProcedureV2::SIG_SPEC{{"is_vertex", {0, lgraph_api::LGraphType::BOOLEAN}},
                                  {"label", {1, lgraph_api::LGraphType::STRING}},
    ...
    ProcedureV2("dbms.meta.refreshCount", BuiltinProcedureV2::DbmsMetaRefreshCount,
              ProcedureV2::SIG_SPEC{}, ProcedureV2::SIG_SPEC{{"", {0, lgraph_api::LGraphType::NUL}}},
              false, true),
    ...
    ProcedureV2("dbms.security.changeUserPassword", BuiltinProcedureV2::DbmsSecurityChangeUserPassword,
              ProcedureV2::SIG_SPEC{
    ...
    ProcedureV2("dbms.security.setUserMemoryLimit", BuiltinProcedureV2::DbmsSecuritySetUserMemoryLimit,
              ProcedureV2::SIG_SPEC{
                  {"user_name", {0, lgraph_api::LGraphType::STRING}},
    ...
    ProcedureV2("dbms.security.deleteAllowedHosts", BuiltinProcedureV2::DbmsSecurityHostWhitelistDelete,
              ProcedureV2::SIG_SPEC{{"hosts", {0, lgraph_api::LGraphType::LIST}}},
              ProcedureV2::SIG_SPEC{{"record_affected", {0, lgraph_api::LGraphType::INTEGER}}}, false,
              true),
    ...
    ProcedureV2("dbms.graph.listGraphs", BuiltinProcedureV2::DbmsGraphListGraphs, ProcedureV2::SIG_SPEC{},
              ProcedureV2::SIG_SPEC{{"graph_name", {0, lgraph_api::LGraphType::STRING}},
    ...
    ProcedureV2("dbms.security.getUserMemoryUsage", BuiltinProcedureV2::DbmsSecurityGetUserMemoryUsage,
              ProcedureV2::SIG_SPEC{{"user", {0, lgraph_api::LGraphType::STRING}}},
              ProcedureV2::SIG_SPEC{{"memory_usage", {0, lgraph_api::LGraphType::INTEGER}}}, true,
              true),

    ProcedureV2("dbms.security.getUserPermissions", BuiltinProcedureV2::DbmsSecurityGetUserPermissions,
              ProcedureV2::SIG_SPEC{{"user", {0, lgraph_api::LGraphType::STRING}}},
              ProcedureV2::SIG_SPEC{{"user_info", {0, lgraph_api::LGraphType::MAP}}}, true, true),
    ...
    ProcedureV2("dbms.security.modRoleAccessLevel", BuiltinProcedureV2::DbmsSecurityModRoleAccessLevel,
              ProcedureV2::SIG_SPEC{{"role", {0, lgraph_api::LGraphType::STRING}},
                                  {"access_level", {1, lgraph_api::LGraphType::MAP}}},
              ProcedureV2::SIG_SPEC{{"", {0, lgraph_api::LGraphType::NUL}}}, false, true),
    ...
    ProcedureV2("db.plugin.getPluginInfo", BuiltinProcedureV2::DbPluginGetPluginInfo,
              ProcedureV2::SIG_SPEC{{"plugin_type", {0, lgraph_api::LGraphType::STRING}},
                                  {"plugin_name", {1, lgraph_api::LGraphType::STRING}}},
              ProcedureV2::SIG_SPEC{{"plugin_description", {0, lgraph_api::LGraphType::MAP}}}, true,
              true),

    ProcedureV2("db.plugin.listPlugin", BuiltinProcedureV2::DbPluginListPlugin,
              ProcedureV2::SIG_SPEC{{"plugin_type", {0, lgraph_api::LGraphType::STRING}},
                                  {"plugin_version", {1, lgraph_api::LGraphType::STRING}}},
              ProcedureV2::SIG_SPEC{{"plugin_description", {0, lgraph_api::LGraphType::MAP}}}, false,
              true),
    ...
    ProcedureV2("db.plugin.callPlugin", BuiltinProcedureV2::DbPluginCallPlugin,
              ...
              ProcedureV2::SIG_SPEC{{"result", {0, lgraph_api::LGraphType::STRING}}}, false, true),
    ...
    ProcedureV2("db.monitor.tuGraphInfo", BuiltinProcedureV2::DbMonitorTuGraphInfo,
              ProcedureV2::SIG_SPEC{},
              ProcedureV2::SIG_SPEC{{"request", {0, lgraph_api::LGraphType::STRING}}}, false, true),

    ProcedureV2("db.monitor.serverInfo", BuiltinProcedureV2::DbMonitorServerInfo, ProcedureV2::SIG_SPEC{},
    ...
    ProcedureV2("dbms.ha.clusterInfo", BuiltinProcedureV2::DbmsHaClusterInfo, ProcedureV2::SIG_SPEC{},
