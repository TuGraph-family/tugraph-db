...
static std::vector<Procedure> global_procedures = {
    ...
    Procedure("db.fullTextIndexes", BuiltinProcedure::DbFullTextIndexes,
                Procedure::SIG_SPEC{},
                Procedure::SIG_SPEC{{"is_vertex", {0, lgraph_api::LGraphType::BOOLEAN}},
    ...
    Procedure("dbms.meta.countDetail", BuiltinProcedure::DbmsMetaCountDetail,
                Procedure::SIG_SPEC{},
                Procedure::SIG_SPEC{{"is_vertex", {0, lgraph_api::LGraphType::BOOLEAN}},
                                      {"label", {1, lgraph_api::LGraphType::STRING}},
    ...
    Procedure("dbms.security.changeUserPassword",
                BuiltinProcedure::DbmsSecurityChangeUserPassword,
                Procedure::SIG_SPEC{
    ...
    Procedure("dbms.security.setUserMemoryLimit",
                BuiltinProcedure::DbmsSecuritySetUserMemoryLimit,
                Procedure::SIG_SPEC{
                    {"user_name", {0, lgraph_api::LGraphType::STRING}},
    ...
    Procedure("dbms.security.deleteAllowedHosts",
                BuiltinProcedure::DbmsSecurityHostWhitelistDelete,
    ...
    Procedure("dbms.graph.listGraphs", BuiltinProcedure::DbmsGraphListGraphs,
                Procedure::SIG_SPEC{},
                Procedure::SIG_SPEC{{"graph_name", {0, lgraph_api::LGraphType::STRING}},
    ...
    Procedure(
        "dbms.security.getUserMemoryUsage", BuiltinProcedure::DbmsSecurityGetUserMemoryUsage,
        Procedure::SIG_SPEC{{"user", {0, lgraph_api::LGraphType::STRING}}},
        Procedure::SIG_SPEC{{"memory_usage", {0, lgraph_api::LGraphType::INTEGER}}}, true, true),

    Procedure("dbms.security.getUserPermissions",
                BuiltinProcedure::DbmsSecurityGetUserPermissions,
                Procedure::SIG_SPEC{{"user", {0, lgraph_api::LGraphType::STRING}}},
                Procedure::SIG_SPEC{{"user_info", {0, lgraph_api::LGraphType::MAP}}}, true, true),
    ...
    Procedure("dbms.security.modRoleAccessLevel",
                BuiltinProcedure::DbmsSecurityModRoleAccessLevel,
                Procedure::SIG_SPEC{{"role", {0, lgraph_api::LGraphType::STRING}},
                                      {"access_level", {1, lgraph_api::LGraphType::MAP}}},
                Procedure::SIG_SPEC{{"", {0, lgraph_api::LGraphType::NUL}}}, false, true),
    ...
    Procedure("db.plugin.callPlugin", BuiltinProcedure::DbPluginCallPlugin,
                ...
                Procedure::SIG_SPEC{{"result", {0, lgraph_api::LGraphType::STRING}}}, false,
                true),
    ...
    Procedure("db.monitor.serverInfo", BuiltinProcedure::DbMonitorServerInfo,
                Procedure::SIG_SPEC{},
    ...
    Procedure("dbms.ha.clusterInfo", BuiltinProcedure::DbmsHaClusterInfo,
                Procedure::SIG_SPEC{},
