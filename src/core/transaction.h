...
class Transaction {
 ...
 public:
    ...
    EdgeIndexIterator GetEdgeIndexIterator(size_t label_id, size_t field_id, VertexId src,
                                           VertexId dst, const FieldData& key_start = FieldData(),
                                           const FieldData& key_end = FieldData());

    EdgeIndexIterator GetEdgeIndexIterator(const std::string& label, const std::string& field,
                                           VertexId src, VertexId dst, const std::string& key_start,
                                           const std::string& key_end);
