 ...
 *
 * It is suitable for those objects with a small amount, and are shared at
 * different places.
 *
 * ThreadSafe: NO.
 */
...
class ObjectAllocator {
 ...
 private:
  ...
  // ObjectHolder holds an object and its destructor, release the resource hold
  // by the object in the destructor of this holder.
  class ObjectHolder {
   public:
    template <typename T>
