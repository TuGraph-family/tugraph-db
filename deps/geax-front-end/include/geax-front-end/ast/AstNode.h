...
#define MAKE_AST_NODE_TYPE(TYPE)                                               \
  ...
  TYPE(BindingTableInnerQuery, kBindingTableInnerQuery,                        \
  ...
  TYPE(StandaloneCallStatement, kStandaloneCallStatement,                      \
  ...
  TYPE(FocusedResultStatement, kFocusedResultStatement,                        \
  ...
  TYPE(CallProcedureStatement, kCallProcedureStatement,                        \
  ...
  TYPE(PrimitiveResultStatement, kPrimitiveResultStatement,                    \
       "PrimitiveResultStatement")                                             \
  TYPE(CatalogModifyStatement, kCatalogModifyStatement,                        \
       "CatalogModifyStatement")                                               \
  TYPE(ManagerStatement, kManagerStatement, "ManagerStatement")                \
  TYPE(ShowProcessListStatement, kShowProcessListStatement,                    \
       "ShowProcessListStatement")                                             \
  TYPE(KillStatement, kKillStatement, "KillStatement")                         \
  TYPE(LinearDataModifyingStatement, kDataModifyStatement,                     \
       "DataModifyStatement")                                                  \
...
class DummyNode : public AstNode {
 public:
  ...
  std::any accept(AstNodeVisitor&) override {
