...
class AstNodeVisitor {
 public:
    ...
    virtual std::any visit(RemoveLabel* node) = 0;
    ...
    virtual std::any visit(PredicateFunction* node) = 0;
...
class AstExprNodeVisitorImpl : public AstNodeVisitor {
 public:
    ...
    virtual std::any visit(RemoveLabel*) override {
        return GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
    }
    ...
    virtual std::any visit(PredicateFunction* node) override = 0;
...
class AstLabelTreeNodeVisitorImpl : public AstNodeVisitor {
 public:
    ...
    virtual std::any visit(PredicateFunction*) override {
        return GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
    }
