...
inline bool If::equals(const Expr& other) const {
  ...
  bool ret = (nullptr != condition_) && (nullptr != expr.condition_) &&
             (nullptr != trueBody_) && (nullptr != expr.trueBody_) &&
             (nullptr != falseBody_) && (nullptr != expr.falseBody_);
  ret = ret && *condition_ == *expr.condition_ &&
        *trueBody_ == *expr.trueBody_ && *falseBody_ == *expr.falseBody_;
  return ret;
}
