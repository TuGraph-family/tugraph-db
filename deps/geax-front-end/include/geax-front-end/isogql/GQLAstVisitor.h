...
/**
 * A GQLAstVisitor visits the parse tree of a ISO/GQL query, to generate a
 * responding IR.
 */
class GQLAstVisitor : public parser::GqlParserBaseVisitor {
 ...
 private:
  ...
  std::any visitSessionActivity(
      parser::GqlParser::SessionActivityContext *ctx) override;
  std::any visitExplainActivity(
      parser::GqlParser::ExplainActivityContext *ctx) override;
  std::any visitGqlFullTransaction(
      parser::GqlParser::GqlFullTransactionContext *ctx) override;
  std::any visitGqlNormalTransaction(
      parser::GqlParser::GqlNormalTransactionContext *ctx) override;
  std::any visitGqlEndTransaction(
      parser::GqlParser::GqlEndTransactionContext *ctx) override;
  std::any visitStartTransactionCommand(
      parser::GqlParser::StartTransactionCommandContext *ctx) override;
  std::any visitSessionSetCommand(
      parser::GqlParser::SessionSetCommandContext *ctx) override;
  std::any visitSessionResetCommand(
      parser::GqlParser::SessionResetCommandContext *ctx) override;
  ...
  std::any visitSessionSetBindingTableParameterClause(
      parser::GqlParser::SessionSetBindingTableParameterClauseContext *ctx)
      override;
  std::any visitProcedureBody(
      parser::GqlParser::ProcedureBodyContext *ctx) override;
  ...
  std::any visitStatementBlock(
      parser::GqlParser::StatementBlockContext *ctx) override;
  std::any visitNextStatement(
      parser::GqlParser::NextStatementContext *ctx) override;
  std::any visitManagerStatement(
      parser::GqlParser::ManagerStatementContext *ctx) override;
  std::any visitLinearCatalogModifyingStatement(
      parser::GqlParser::LinearCatalogModifyingStatementContext *ctx) override;
  std::any visitQueryStatement(
      parser::GqlParser::QueryStatementContext *ctx) override;
  std::any visitStandaloneCallStatement(
      parser::GqlParser::StandaloneCallStatementContext *ctx) override;
  std::any visitJoinQueryExpression(
      parser::GqlParser::JoinQueryExpressionContext *ctx) override;
  ...
  std::any visitAmbientLinearDataModifyingStatementBody(
      parser::GqlParser::AmbientLinearDataModifyingStatementBodyContext *ctx)
      override;

  std::any visitInsertStatement(
      parser::GqlParser::InsertStatementContext *ctx) override;
  std::any visitSetStatement(
      parser::GqlParser::SetStatementContext *ctx) override;
  std::any visitSetPropertyItem(
      parser::GqlParser::SetPropertyItemContext *ctx) override;
  ...
  std::any visitSetLabelItem(
      parser::GqlParser::SetLabelItemContext *ctx) override;
  std::any visitDeleteStatement(
      parser::GqlParser::DeleteStatementContext *ctx) override;
  std::any visitReplaceStatement(
      parser::GqlParser::ReplaceStatementContext *ctx) override;
  std::any visitMergeStatement(
      parser::GqlParser::MergeStatementContext *ctx) override;
  std::any visitGqlMergeOnMatch(
      parser::GqlParser::GqlMergeOnMatchContext *ctx) override;
  std::any visitGqlMergeOnCreate(
      parser::GqlParser::GqlMergeOnCreateContext *ctx) override;

  std::any visitFilterStatement(
      parser::GqlParser::FilterStatementContext *ctx) override;
  ...
  std::any visitMatchStatementBlock(
      parser::GqlParser::MatchStatementBlockContext *ctx) override;
  std::any visitForStatement(
      parser::GqlParser::ForStatementContext *ctx) override;

  std::any visitReturnStatementBody(
      parser::GqlParser::ReturnStatementBodyContext *ctx) override;
  std::any visitReturnItemList(
      parser::GqlParser::ReturnItemListContext *ctx) override;
  std::any visitReturnItem(parser::GqlParser::ReturnItemContext *ctx) override;
  std::any visitBindingVariable(
      parser::GqlParser::BindingVariableContext *ctx) override;
  std::any visitParameter(parser::GqlParser::ParameterContext *ctx) override;
  std::any visitHintItemlist(
      parser::GqlParser::HintItemlistContext *ctx) override;
  std::any visitGqlReadConsistency(
      parser::GqlParser::GqlReadConsistencyContext *ctx) override;
  std::any visitGqlAllowAnonymousTable(
      parser::GqlParser::GqlAllowAnonymousTableContext *ctx) override;
  std::any visitGqlEdgeOnJoin(
      parser::GqlParser::GqlEdgeOnJoinContext *ctx) override;
  std::any visitSelectStatement(
      parser::GqlParser::SelectStatementContext *ctx) override;
  std::any visitSelectItemList(
      parser::GqlParser::SelectItemListContext *ctx) override;
  std::any visitSelectItem(parser::GqlParser::SelectItemContext *ctx) override;
  std::any visitSelectStatementBody(
      parser::GqlParser::SelectStatementBodyContext *ctx) override;

  // orderByAndPageStatement
  std::any visitOrderByAndPageStatement(
      parser::GqlParser::OrderByAndPageStatementContext *ctx) override;
  std::any visitSortSpecification(
      parser::GqlParser::SortSpecificationContext *ctx) override;

  // call procedure
  std::any visitCallQueryStatement(
      parser::GqlParser::CallQueryStatementContext *ctx) override;
  std::any visitCallProcedureStatement(
      parser::GqlParser::CallProcedureStatementContext *ctx) override;
  std::any visitInlineProcedureCall(
      parser::GqlParser::InlineProcedureCallContext *ctx) override;
  std::any visitNamedProcedureCall(
      parser::GqlParser::NamedProcedureCallContext *ctx) override;

  // clause
  std::any visitGraphPattern(
      parser::GqlParser::GraphPatternContext *ctx) override;
  std::any visitPathPatternList(
      parser::GqlParser::PathPatternListContext *ctx) override;
  std::any visitPathPattern(
      parser::GqlParser::PathPatternContext *ctx) override;
  std::any visitPathTerm(parser::GqlParser::PathTermContext *ctx) override;
  std::any visitPathPatternUnion(
      parser::GqlParser::PathPatternUnionContext *ctx) override;
  ...
  std::any visitYieldItemList(
      parser::GqlParser::YieldItemListContext *ctx) override;
  std::any visitYieldItem(parser::GqlParser::YieldItemContext *ctx) override;
  std::any visitPathModePrefix(
      parser::GqlParser::PathModePrefixContext *ctx) override;
  std::any visitAllPathSearch(
      parser::GqlParser::AllPathSearchContext *ctx) override;
  std::any visitAnyPathSearch(
      parser::GqlParser::AnyPathSearchContext *ctx) override;
  ...
  GEAXErrorCode visitPathMode(parser::GqlParser::PathModeContext *ctx,
                              ModeType &modeType);
  ...
  std::any visitGqlGraphPatternAsteriskQuantifier(
      parser::GqlParser::GqlGraphPatternAsteriskQuantifierContext *ctx)
      override;
  std::any visitGqlGraphPatternPlusSignQuantifier(
      parser::GqlParser::GqlGraphPatternPlusSignQuantifierContext *ctx)
      override;
  std::any visitFixedQuantifier(
      parser::GqlParser::FixedQuantifierContext *ctx) override;
  std::any visitGeneralQuantifier(
      parser::GqlParser::GeneralQuantifierContext *ctx) override;
  GEAXErrorCode setEdgePatternHopRange(AstNode *edgeNode, IntParam &&lower,
                                       std::optional<IntParam> &&upper);

  std::any visitInsertPathPattern(
      parser::GqlParser::InsertPathPatternContext *ctx) override;
  std::any visitInsertNodePattern(
      parser::GqlParser::InsertNodePatternContext *ctx) override;
  GEAXErrorCode visitInsertEdgePattern(
      EdgeDirection direction,
      parser::GqlParser::InsertElementPatternFillerContext *fillerCtx);
  ...
  std::any visitNodePattern(
      parser::GqlParser::NodePatternContext *ctx) override;
  ...
  GEAXErrorCode visitElementPatternPredicates(
      std::vector<parser::GqlParser::ElementPatternPredicateContext *>
          &predicateCtxs,
      ElementFiller *filler);

  GEAXErrorCode visitFullEdgePattern(
      EdgeDirection direction,
  ...
  std::any visitFullEdgeUndirected(
      parser::GqlParser::FullEdgeUndirectedContext *ctx) override;
  ...
  std::any visitFullEdgeLeftOrRight(
      parser::GqlParser::FullEdgeLeftOrRightContext *ctx) override;
  ...
  std::any visitWhereClause(
      parser::GqlParser::WhereClauseContext *ctx) override;
  std::any visitGroupingElement(
      parser::GqlParser::GroupingElementContext *ctx) override;
  ...
  // expression
  std::any visitGqlNotExpression(
      parser::GqlParser::GqlNotExpressionContext *ctx) override;
  ...
  // predicates
  std::any visitGqlInExpression(
      parser::GqlParser::GqlInExpressionContext *ctx) override;
  std::any visitGqlLikeExpression(
      parser::GqlParser::GqlLikeExpressionContext *ctx) override;
  ...
  std::any visitGqlExistsExpression(
      parser::GqlParser::GqlExistsExpressionContext *ctx) override;
  std::any visitGqlNullExpression(
      parser::GqlParser::GqlNullExpressionContext *ctx) override;
  ...
  std::any visitGqlSameExpression(
      parser::GqlParser::GqlSameExpressionContext *ctx) override;

  // atom
  std::any visitGqlPropertyReference(
      parser::GqlParser::GqlPropertyReferenceContext *ctx) override;
  std::any visitGqlUnaryExpression(
      parser::GqlParser::GqlUnaryExpressionContext *ctx) override;
  std::any visitGqlValueQueryExpression(
      parser::GqlParser::GqlValueQueryExpressionContext *ctx) override;
  std::any visitGqlBitXorExpression(
      parser::GqlParser::GqlBitXorExpressionContext *ctx) override;
  std::any visitGqlBitShiftExpression(
      parser::GqlParser::GqlBitShiftExpressionContext *ctx) override;
  std::any visitGqlBitAndExpression(
      parser::GqlParser::GqlBitAndExpressionContext *ctx) override;
  std::any visitGqlBitOrExpression(
      parser::GqlParser::GqlBitOrExpressionContext *ctx) override;
  ...
  std::any visitLabelExpression(
      parser::GqlParser::LabelExpressionContext *ctx) override;
  std::any visitLabelTerm(parser::GqlParser::LabelTermContext *ctx) override;
  std::any visitLabelFactor(
      parser::GqlParser::LabelFactorContext *ctx) override;

  // literal
  std::any visitFloatLiteral(
      parser::GqlParser::FloatLiteralContext *ctx) override;
  std::any visitIntegerLiteral(
      parser::GqlParser::IntegerLiteralContext *ctx) override;
  std::any visitBooleanLiteral(
      parser::GqlParser::BooleanLiteralContext *ctx) override;
  std::any visitCharacterStringLiteral(
      parser::GqlParser::CharacterStringLiteralContext *ctx) override;
  std::any visitByteStringLiteral(
      parser::GqlParser::ByteStringLiteralContext *ctx) override;
  std::any visitNullLiteral(
      parser::GqlParser::NullLiteralContext *ctx) override;
  std::any visitDateLiteral(
      parser::GqlParser::DateLiteralContext *ctx) override;
  std::any visitDatetimeLiteral(
      parser::GqlParser::DatetimeLiteralContext *ctx) override;
  std::any visitTimeLiteral(
      parser::GqlParser::TimeLiteralContext *ctx) override;
  std::any visitListLiteral(
      parser::GqlParser::ListLiteralContext *ctx) override;
  std::any visitMapLiteral(parser::GqlParser::MapLiteralContext *ctx) override;
  std::any visitRecordLiteral(
      parser::GqlParser::RecordLiteralContext *ctx) override;
  std::any visitDurationLiteral(
      parser::GqlParser::DurationLiteralContext *ctx) override;
  ...
  std::any visitGqlIfFunction(
      parser::GqlParser::GqlIfFunctionContext *ctx) override;
  std::any visitGeneralFunction(
      parser::GqlParser::GeneralFunctionContext *ctx) override;
  ...
  std::any visitElementFunction(
      parser::GqlParser::ElementFunctionContext *ctx) override;
  std::any visitGqlListTrimFunction(
      parser::GqlParser::GqlListTrimFunctionContext *ctx) override;
  std::any visitGqlElementsOfPathFunction(
      parser::GqlParser::GqlElementsOfPathFunctionContext *ctx) override;

  // aggregate functions
  std::any visitGqlCountAllFunction(
      parser::GqlParser::GqlCountAllFunctionContext *ctx) override;
  ...
  std::any visitGqlWindowFunction(
      parser::GqlParser::GqlWindowFunctionContext *ctx) override;
  std::any visitWindowClause(
      parser::GqlParser::WindowClauseContext *ctx) override;
  GEAXErrorCode visitAggExpr(
      parser::GqlParser::GeneralSetFunctionTypeContext *typeCtx,
  ...
  GEAXErrorCode visitFunction(
      ...
      const std::vector<parser::GqlParser::FunctionParameterContext *>
          &funcParams);
  GEAXErrorCode visitTableFunction(
      parser::GqlParser::TableFunctionNameContext *funcName,
      const std::vector<parser::GqlParser::EleTableFuncParameterContext *>
          &funcParams);

  // cast functions
  std::any visitCastFunction(
      parser::GqlParser::CastFunctionContext *ctx) override;

  std::any visitQueryConjunction(
      parser::GqlParser::QueryConjunctionContext *ctx) override;
  std::any visitSetOperator(
      parser::GqlParser::SetOperatorContext *ctx) override;
  std::any visitPropertyReference(
      parser::GqlParser::PropertyReferenceContext *ctx) override;

  // collections
  std::any visitListValueConstructor(
      parser::GqlParser::ListValueConstructorContext *ctx) override;
  std::any visitMapValueConstructor(
      parser::GqlParser::MapValueConstructorContext *ctx) override;
  ...
  // remove function
  std::any visitRemoveStatement(
      parser::GqlParser::RemoveStatementContext *ctx) override;
  std::any visitRemovePropertyItem(
      parser::GqlParser::RemovePropertyItemContext *ctx) override;

  // helper functions
  GEAXErrorCode visitBinaryExpr(antlr4::ParserRuleContext *lhs,
                                antlr4::ParserRuleContext *rhs, BinaryOp *expr);
  GEAXErrorCode visitListExpr(
      std::vector<parser::GqlParser::ExpressionContext *> &epxrs, MkList *list);
  GEAXErrorCode visitListLiteralItem(
      std::vector<parser::GqlParser::GeneralLiteralContext *> &literalCtxs,
      MkList *list);
