...
#ifndef VISIT_RULE
#define VISIT_RULE(RuleCtx, NodeType, Node) \
  VISIT_RULE_I(RuleCtx, NodeType, Node)
#define VISIT_RULE_I(RuleCtx, NodeType, Node)                                  \
  ({                                                                           \
    ...
    if (GEAX_RET_FAIL(checkChildResult())) {                                   \
      ...
      LOG(WARNING) << "Result should be " << KV("type", NodeType)              \
                   << ", actual " << KV("type", childRes_->type()) << DK(ret); \
    } else if (GEAX_UNLIKELY(!uncheckedCast(childRes_, Node))) {               \
      ret = GEAXErrorCode::GEAX_COMMON_PARSE_ERROR;                            \
      LOG(WARNING) << "Failed to cast to node " << #NodeType << ": "           \
                   << K(ret);                                                  \
    }                                                                          \
    ret;                                                                       \
  })
...
#define VISIT_RULE_WITH_FA(RuleCtx, FaNode) \
  VISIT_RULE_WITH_FA_I(RuleCtx, FaNode)
...
// Some basic rules:
// 1) we do not check rule ctx pointer as parameters, because we checked before
// passing it 2) but MUST check its children 3) if you change faRes_, please
// recover it after visiting a node, which is done by VISIT_RULE_WITH_FA
...
std::any GQLAstVisitor::visitExplainActivity(
    parser::GqlParser::ExplainActivityContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  } else if (GEAX_RET_FAIL(VISIT_RULE(procedureCtx, AstNodeType::kProcedureBody,
                                      procedureBody))) {
...
std::any GQLAstVisitor::visitSessionActivity(
  ...
  for (auto i = 0u; i < sessionCtxs.size() && GEAX_OK(ret); ++i) {
    ...
    if (GEAX_IS_NULL(sessionCtxs[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING)
          << "SessionActivityCommand is not set in rule SessionActivity: "
          << K(ret);
...
std::any GQLAstVisitor::visitGqlFullTransaction(
    GqlParser::GqlFullTransactionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  TransactionActivity* transactionActivity =
      ALLOC_GEAOBJECT(TransactionActivity);
  ...
  if (GEAX_IS_NULL(startCtx = ctx->startTransactionCommand())) {
    ...
    LOG(WARNING) << "GqlBlock is not supported in transaction yet: " << K(ret);
                 ...
                 VISIT_RULE(startCtx, AstNodeType::kStartTransaction, start))) {
...
std::any GQLAstVisitor::visitGqlNormalTransaction(
    GqlParser::GqlNormalTransactionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  TransactionActivity* transactionActivity =
      ALLOC_GEAOBJECT(TransactionActivity);
  DEFER(transactionActivity, ret);
...
std::any GQLAstVisitor::visitGqlEndTransaction(
    GqlParser::GqlEndTransactionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  TransactionActivity* transactionActivity =
      ALLOC_GEAOBJECT(TransactionActivity);
  DEFER(transactionActivity, ret);
...
std::any GQLAstVisitor::visitStartTransactionCommand(
  ...
  if (ctx->transactionCharacteristics() != nullptr) {
    ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
    LOG(WARNING) << "TransactionCharacteristics is not supported yet: "
                 << K(ret);
  }
  return std::any();
}

std::any GQLAstVisitor::visitSessionSetCommand(
    GqlParser::SessionSetCommandContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_RET_FAIL(byPass(ctx))) {
    ...
    switch (childRes_->type()) {
      case AstNodeType::kSetParam:
        sessionSet->setCommand(
            castAs<SetParamClause>(childRes_, AstNodeType::kSetParam));
        break;
      default:
        ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
        LOG(WARNING)
            << "SessionSetCommand except parameter is not supported yet: "
            << K(ret);
    }
  }
  return std::any();
...
std::any GQLAstVisitor::visitSessionResetCommand(
    GqlParser::SessionResetCommandContext* ctx) {
...
std::any GQLAstVisitor::visitSessionSetValueParameterClause(
  ...
  GqlParser::SessionSetParameterNameContext* setNameCtx =
      ctx->sessionSetParameterName();
  GqlParser::OptTypedValueInitializerContext* setValueCtx =
      ctx->optTypedValueInitializer();
  ...
  if (GEAX_ANY_NULL(setNameCtx, setValueCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of SessionSetValueParameterClause is not set: "
                 << K(ret);
...
std::any GQLAstVisitor::visitProcedureBody(
    GqlParser::ProcedureBodyContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (ctx->atSchemaClause() != nullptr) {
    ...
    if (GEAX_RET_FAIL(VISIT_RULE_WITH_FA(bindingCtx, procedure))) {
      LOG(WARNING) << "Failed to visit rule BindingVariableDefinitionBlock: "
                   << K(ret);
    }
  }
  return std::any();
...
std::any GQLAstVisitor::visitBindingVariableDefinitionBlock(
  ...
  if (GEAX_IS_NULL(procedure = castAs<ProcedureBody>(
                       faRes_, AstNodeType::kProcedureBody))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    ...
    for (auto i = 0u; i < bindingVarCtxs.size() && GEAX_OK(ret); ++i) {
      ...
      if (GEAX_IS_NULL(bindingVarCtxs[i])) {
        ...
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(WARNING) << "Child result should be a BindingDefinition: "
                     << K(ret);
      } else {
...
std::any GQLAstVisitor::visitBindingTableVariableDefinition(
  ...
  if (GEAX_ANY_NULL(tableVarCtx = ctx->bindingTableVariable(),
    ...
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of BindingTableVariableDefinition is not set: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(tableVarCtx, ref))) {
    LOG(WARNING) << "Failed to visit rule BindingTableVariable: " << K(ret);
  } else if (GEAX_IS_NULL(tableInitCtx =
                              optInitCtx->bindingTableInitializer())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "BindingTableInitializer is not set: " << K(ret);
  } else if (GEAX_IS_NULL(tableExprCtx =
                              tableInitCtx->bindingTableExpression())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
...
std::any GQLAstVisitor::visitNestedQuerySpecification(
  ...
  if (GEAX_IS_NULL(procedureCtx = ctx->procedureSpecification())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING)
        << "ProcedureSpecification is not set in NestedQuerySpecification: "
        << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_RULE(procedureCtx, AstNodeType::kProcedureBody,
                                      procedureBody))) {
    LOG(WARNING) << "Failed to visit rule ProcedureSpecification: " << K(ret);
...
std::any GQLAstVisitor::visitBindingTableReference(
    GqlParser::BindingTableReferenceContext* ctx) {
  childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}
...
std::any GQLAstVisitor::visitStatementBlock(
  ...
  if (GEAX_IS_NULL(procedure = castAs<ProcedureBody>(
    ...
    ret = GEAXErrorCode::GEAX_OOPS;
    LOG(WARNING) << "Result after visiting rule Statement should be Statement: "
                 << K(ret);
  } else {
    ...
    for (auto i = 0u; i < nextStmts.size() && GEAX_OK(ret); ++i) {
      ...
      if (GEAX_IS_NULL(nextStmts[i])) {
        ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
        LOG(WARNING) << "ThenStatement is not set in rule StatementBlock: "
                     << K(ret);
      } else if (GEAX_RET_FAIL(VISIT_RULE(nextStmts[i],
                                          AstNodeType::kStatementWithYield,
                                          nextStmt))) {
...
std::any GQLAstVisitor::visitNextStatement(
    GqlParser::NextStatementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (nullptr != (yieldCtx = ctx->yieldClause())) {
    ...
    if (GEAX_RET_FAIL(
            VISIT_RULE(yieldCtx, AstNodeType::kYieldField, yieldNode))) {
...
std::any GQLAstVisitor::visitManagerStatement(
    GqlParser::ManagerStatementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (ctx->SHOW() != nullptr) {
...
std::any GQLAstVisitor::visitQueryStatement(
    GqlParser::QueryStatementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(joinCtx = ctx->joinQueryExpression())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "JoinQueryExpression is not set in rule QueryStatement: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(
                 VISIT_RULE(joinCtx, AstNodeType::kJoinQuery, joinQuery))) {
...
std::any GQLAstVisitor::visitStandaloneCallStatement(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  StandaloneCallStatement* standaloneCall =
      ALLOC_GEAOBJECT(StandaloneCallStatement);
  ...
  if (GEAX_IS_NULL(callCtx = ctx->callProcedureStatement())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING)
        << "CallProcedureStatement is not set in rule StandaloneCallStatement: "
        << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_RULE(
                 callCtx, AstNodeType::kCallProcedureStatement, callStmt))) {
...
std::any GQLAstVisitor::visitJoinQueryExpression(
    GqlParser::JoinQueryExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_UNLIKELY(joinCtxs.size() != 0)) {
    ...
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING)
        << "CompositeQueryStatement is not set in rule JoinQueryExpression: "
        << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_RULE(compositeCtx,
                                      AstNodeType::kCompositeStatement,
                                      compositeStmt))) {
...
std::any GQLAstVisitor::visitCompositeQueryExpression(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  CompositeQueryStatement* compositeStmt =
      ALLOC_GEAOBJECT(CompositeQueryStatement);
  ...
  if (GEAX_UNLIKELY_NE(queryCtxs.size(), conjunctionCtxs.size() + 1)) {
    ...
    for (auto i = 0u; i < conjunctionCtxs.size() && GEAX_OK(ret); ++i) {
      ...
      if (GEAX_ANY_NULL(conjunctionCtxs[i], queryCtxs[i + 1])) {
        ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
        LOG(WARNING) << "Child of CompositeQueryStatement is not set: "
                     << K(ret);
      } else if (GEAX_RET_FAIL(ACCEPT_RULE(queryCtxs[i + 1]))) {
        LOG(WARNING) << "Failed to visit rule LinearQueryStatement: " << K(ret);
      } else if (GEAX_UNLIKELY(!checkedCast(childRes_, stmt))) {
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(WARNING) << "Child result should be a LinearQueryStatement: "
                     << K(ret);
        ...
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(WARNING) << "Child result should be a QueryConjunctionType: "
                     << K(ret);
      } else {
...
std::any GQLAstVisitor::visitFocusedQueryStatement(
    GqlParser::FocusedQueryStatementContext* ctx) {
  childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}
...
std::any GQLAstVisitor::visitAmbientLinearQueryStatement(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  AmbientLinearQueryStatement* ambientStmt =
      ALLOC_GEAOBJECT(AmbientLinearQueryStatement);
  ...
  if (GEAX_IS_NULL(resultCtx = ctx->primitiveResultStatement())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "PrimitiveResultStatement is not set in "
                    "AmbientLinearQueryStatement: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_RULE(
                 resultCtx, AstNodeType::kPrimitiveResultStatement, result))) {
  ...
  if (GEAX_FAIL(ret)) {
    ...
    for (auto i = 0u; GEAX_OK(ret) && i < queryStmtList.size(); ++i) {
      if (GEAX_IS_NULL(queryStmtList[i])) {
        ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
        LOG(WARNING)
            << "SimpleQueryStatement is not set in SimpleLinearQueryStatement: "
            << K(ret);
        ...
        switch (childRes_->type()) {
          case AstNodeType::kMatchStatement:
            ambientStmt->appendQueryStatement(castAs<MatchStatement>(
                childRes_, AstNodeType::kMatchStatement));
            break;
          case AstNodeType::kFilterStatement:
            ambientStmt->appendQueryStatement(castAs<FilterStatement>(
                childRes_, AstNodeType::kFilterStatement));
            break;
          ...
          case AstNodeType::kCallQueryStatement:
            ambientStmt->appendQueryStatement(castAs<CallQueryStatement>(
                childRes_, AstNodeType::kCallQueryStatement));
            break;
          default:
            ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
            LOG(WARNING) << "Child type is not supported. "
...
std::any GQLAstVisitor::visitPrimitiveResultStatement(
  ...
  if (GEAX_IS_NULL(returnCtx = ctx->returnStatement())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "ReturnStatement is not set in PrimitiveResultStatement: "
                 << K(ret);
...
std::any GQLAstVisitor::visitAmbientLinearDataModifyingStatementBody(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  LinearDataModifyingStatement* dataModifyStmt =
      ALLOC_GEAOBJECT(LinearDataModifyingStatement);
        ...
        switch (childRes_->type()) {
          case AstNodeType::kMatchStatement: {
            ...
            if (GEAX_IS_NULL(match = castAs<MatchStatement>(
                                 childRes_, AstNodeType::kMatchStatement))) {
              ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
              LOG(WARNING) << "Failed to cast to node kMatchStatement: "
                           << K(ret);
            } else {
              // TODO(ljr) : multi pathPatterns convert multiMatch. If multi
              // pathPatterns are implemented, change them back.
              auto graphPattern = match->graphPattern();
              if (GEAX_IS_NULL(graphPattern)) {
                ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
                LOG(WARNING)
                    << "GraphPattern is not set in MatchStatement: " << K(ret);
                ...
                if (graphPattern->keep().has_value() ||
                  ...
                  for (auto& pathPattern : graphPattern->pathPatterns()) {
                    if (pathPattern->prefix().has_value() ||
                      ...
                      MatchStatement* matchTmp =
                          ALLOC_GEAOBJECT(MatchStatement);
  ...
  for (auto i = 0u; GEAX_OK(ret) && i < modifyList.size(); ++i) {
    if (GEAX_IS_NULL(modifyList[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING)
          << "Child is not set in AmbientLinearDataModifyingStatementBody: "
          << K(ret);
    } else if (GEAX_RET_FAIL(ACCEPT_RULE(modifyList[i]))) {
      LOG(WARNING) << "Failed to visit SimpleDataModifyingStatement: "
                   << K(ret);
    } else {
      switch (childRes_->type()) {
        ...
        case AstNodeType::kSetStatement: {
          SetStatement* set =
              castAs<SetStatement>(childRes_, AstNodeType::kSetStatement);
          dataModifyStmt->appendModifyStatement(set);
          break;
        }
        case AstNodeType::kReplaceStatement: {
          ReplaceStatement* replace = castAs<ReplaceStatement>(
              childRes_, AstNodeType::kReplaceStatement);
        ...
        case AstNodeType::kRemoveStatement: {
          RemoveStatement* remove =
              castAs<RemoveStatement>(childRes_, AstNodeType::kRemoveStatement);
...
std::any GQLAstVisitor::visitInsertStatement(
  ...
  if (GEAX_IS_NULL(insertGraphPatternCtx = ctx->insertGraphPattern())) {
    ...
    if (GEAX_IS_NULL(patternListCtx =
                         insertGraphPatternCtx->insertPathPatternList())) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      ...
      for (size_t i = 0u; i < patterns.size() && GEAX_OK(ret); ++i) {
        ...
        if (GEAX_IS_NULL(patterns[i])) {
          ...
          LOG(WARNING) << "simplePathPattern is not set: " << K(ret);
                       ...
                       patterns[i], AstNodeType::kPathChain, pathChain))) {
...
std::any GQLAstVisitor::visitSetStatement(GqlParser::SetStatementContext* ctx) {
  ...
  if (GEAX_IS_NULL(setListCtx = ctx->setItemList())) {
    ...
    std::vector<GqlParser::SetItemContext*> setItemCtxVec =
        setListCtx->setItem();
...
std::any GQLAstVisitor::visitSetPropertyItem(
    GqlParser::SetPropertyItemContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_IS_NULL(
          setStmt = castAs<SetStatement>(faRes_, AstNodeType::kSetStatement))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Failed to cast to node kSetStatement: " << K(ret);
  } else if (GEAX_IS_NULL(ctx->bindingVariableReference()) ||
             GEAX_IS_NULL(
                 refCtx = ctx->bindingVariableReference()->bindingVariable())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
...
std::any GQLAstVisitor::visitSetAllPropertiesItem(
    GqlParser::SetAllPropertiesItemContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_IS_NULL(
    ...
    LOG(WARNING) << "PropertyKeyValuePairList is not set: " << K(ret);
                 ...
                 VISIT_RULE(propListCtx, AstNodeType::kPropStruct, prop))) {
...
std::any GQLAstVisitor::visitUpdatePropertiesItem(
    GqlParser::UpdatePropertiesItemContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
...
std::any GQLAstVisitor::visitSetLabelItem(GqlParser::SetLabelItemContext* ctx) {
  ...
  if (GEAX_IS_NULL(
    ...
    LOG(WARNING) << "LabelName is not set: " << K(ret);
                 ...
                 VISIT_RULE(labelCtx, AstNodeType::kSingleLabel, label))) {
...
std::any GQLAstVisitor::visitDeleteStatement(
  ...
  if (nullptr != ctx->DETACH() || nullptr != ctx->NODETACH()) {
    ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
    LOG(WARNING) << "DETACH/NODETACH is not supported in DeleteStatement: "
                 << K(ret);
...
std::any GQLAstVisitor::visitReplaceStatement(
    GqlParser::ReplaceStatementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitMergeStatement(
    GqlParser::MergeStatementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  } else if (GEAX_RET_FAIL(VISIT_RULE(patternCtx, AstNodeType::kPathPattern,
                                      pathPattern))) {
...
std::any GQLAstVisitor::visitGqlMergeOnMatch(
    GqlParser::GqlMergeOnMatchContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_IS_NULL(merge = castAs<MergeStatement>(
                       faRes_, AstNodeType::kMergeStatement))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Failed to cast to node kMergeStatement: " << K(ret);
  } else if (GEAX_IS_NULL(setCtx = ctx->setStatement())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "SetStatement is not set in rule GqlMergeOnMatch: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_RULE(setCtx, AstNodeType::kSetStatement,
                                      setStatement))) {
...
std::any GQLAstVisitor::visitGqlMergeOnCreate(
    GqlParser::GqlMergeOnCreateContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
...
std::any GQLAstVisitor::visitFilterStatement(
  ...
  if (GEAX_IS_NULL(exprCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Expression is not set in rule FilterStatementContext: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(exprCtx, expr))) {
    LOG(WARNING) << "Failed to visit rule Expression: " << K(ret);
  } else {
...
std::any GQLAstVisitor::visitSimpleMatchStatement(
    GqlParser::SimpleMatchStatementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(graphBindingTableCtx = ctx->graphPatternBindingTable())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING)
        << "GraphPatternBindingTable is not set in SimpleMatchStatement: "
        << K(ret);
  } else if (GEAX_IS_NULL(graphPatternCtx =
                              graphBindingTableCtx->graphPattern())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "GraphPattern is not set in GraphPatternBindingTable: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_RULE(
                 graphPatternCtx, AstNodeType::kGraphPattern, graphPattern))) {
  ...
  if (GEAX_FAIL(ret)) {
             ...
             (yieldCtx = graphBindingTableCtx->graphPatternYieldClause())) {
    YieldField* yieldNode = nullptr;
    if (GEAX_RET_FAIL(
            VISIT_RULE(yieldCtx, AstNodeType::kYieldField, yieldNode))) {
      LOG(WARNING) << "Failed to visit rule Yield: " << K(ret);
...
std::any GQLAstVisitor::visitOptionalMatchStatement(
    GqlParser::OptionalMatchStatementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  MatchStatement* match = nullptr;
  DEFER(match, ret);
  ...
  if (GEAX_IS_NULL(optionCtx = ctx->optionalOperand())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "OptionalOperand is not set in OptionalMatchStatement: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(
                 VISIT_RULE(optionCtx, AstNodeType::kMatchStatement, match))) {
    LOG(WARNING) << "Failed to visit rule GraphPattern: " << K(ret);
  } else {
...
std::any GQLAstVisitor::visitMatchStatementBlock(
    GqlParser::MatchStatementBlockContext* ctx) {
  childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}
...
std::any GQLAstVisitor::visitForStatement(GqlParser::ForStatementContext* ctx) {
  ...
  if (GEAX_FAIL(ret)) {
    ...
    if (GEAX_IS_NULL(idCtx = ordinalityCtx->identifier())) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING) << "Identifier is not set in ForOrdinalityOrOffset: "
                   << K(ret);
    } else {
      forStatement->setOrdinalityOrOffset(
          ordinalityCtx->ORDINALITY() == nullptr ? false : true,
          idCtx->getText());
    }
  }
  return std::any();
...
std::any GQLAstVisitor::visitPathPatternList(
    GqlParser::PathPatternListContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);

  GraphPattern* graphPattern = nullptr;
  if (GEAX_IS_NULL(graphPattern = castAs<GraphPattern>(
                       faRes_, AstNodeType::kGraphPattern))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
  ...
  for (auto i = 0u; GEAX_OK(ret) && i < pathCtxs.size(); ++i) {
    ...
    if (GEAX_IS_NULL(pathCtxs[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING) << "PathPattern is not set in rule PathPatternList: "
                   << K(ret);
    } else if (GEAX_RET_FAIL(VISIT_RULE(pathCtxs[i], AstNodeType::kPathPattern,
                                        pathPattern))) {
      LOG(WARNING) << "Failed to visit rule PathPattern: " << K(ret);
    } else {
  ...
  for (auto i = 0u; i < ctx->children.size() && GEAX_OK(ret); ++i) {
    ...
    if (checkedCast(ctx->children[i], varCtx)) {
      ...
      if (GEAX_IS_NULL(pathVarCtx = varCtx->pathVariable())) {
        ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
        LOG(WARNING)
            << "PathVariable is not set in rule PathVariableDeclaration: "
            << K(ret);
      } else {
      ...
      PathChain* pathChain = nullptr;
      if (GEAX_RET_FAIL(
              VISIT_RULE(pathExprCtx, AstNodeType::kPathChain, pathChain))) {
        LOG(WARNING) << "Failed to visit rule PathPatternExpression: "
                     << K(ret);
      } else {
...
std::any GQLAstVisitor::visitPathTerm(GqlParser::PathTermContext* ctx) {
  ...
  if (GEAX_UNLIKELY(pathCtxs.empty())) {
    ...
    LOG(WARNING) << "Child of rule PathFactor is not set: " << K(ret);
                 ...
                 VISIT_RULE(pathCtxs[0], AstNodeType::kNode, start))) {
  ...
  for (auto i = 1u; i + 1 < pathCtxs.size() && GEAX_OK(ret); i += 2) {
    ...
    if (GEAX_ANY_NULL(pathCtxs[i], pathCtxs[i + 1])) {
      ...
      LOG(WARNING) << "Failed to visit rule PathFactor: " << K(ret);
                   ...
                   VISIT_RULE(pathCtxs[i + 1], AstNodeType::kNode, v))) {
      LOG(WARNING) << "Failed to visit rule PathFactor: " << K(ret);
    } else {
...
std::any GQLAstVisitor::visitPathPatternUnion(
    GqlParser::PathPatternUnionContext* ctx) {
  childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}
...
std::any GQLAstVisitor::visitYieldItemList(
    GqlParser::YieldItemListContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitYieldItem(GqlParser::YieldItemContext* ctx) {
  ...
  if (GEAX_IS_NULL(yield =
                       castAs<YieldField>(faRes_, AstNodeType::kYieldField))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
...
std::any GQLAstVisitor::visitPathModePrefix(
    GqlParser::PathModePrefixContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(pathModeCtx = ctx->pathMode())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of rule PathModePrefixContext is not set: "
                 << K(ret);
...
std::any GQLAstVisitor::visitAllPathSearch(
    GqlParser::AllPathSearchContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitAnyPathSearch(
    GqlParser::AnyPathSearchContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  PathSearchPrefix* prefix = ALLOC_GEAOBJECT(PathSearchPrefix);
  DEFER(prefix, ret);
...
std::any GQLAstVisitor::visitAllShortestPathSearch(
    GqlParser::AllShortestPathSearchContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  PathSearchPrefix* prefix = ALLOC_GEAOBJECT(PathSearchPrefix);
  DEFER(prefix, ret);
  GqlParser::PathModeContext* pathModeCtx = nullptr;
...
std::any GQLAstVisitor::visitAnyShortestPathSearch(
    GqlParser::AnyShortestPathSearchContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  PathSearchPrefix* prefix = ALLOC_GEAOBJECT(PathSearchPrefix);
  DEFER(prefix, ret);
...
std::any GQLAstVisitor::visitCountedShortestPathSearch(
  ...
  if (GEAX_IS_NULL(numCtx = ctx->numberOfPaths())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "NumberOfPaths is not set in CountedShortestPathSearch: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(numCtx, integerNode))) {
    LOG(WARNING) << "Failed to visit IntegerLiteral: " << K(ret);
  } else {
...
std::any GQLAstVisitor::visitCountedShortestGroupSearch(
  ...
  if (GEAX_IS_NULL(numCtx = ctx->numberOfGroups())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "NumberOfGroups is not set in CountedShortestPathSearch: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(numCtx, integerNode))) {
    LOG(WARNING) << "Failed to visit IntegerLiteral: " << K(ret);
  } else {
...
GEAXErrorCode GQLAstVisitor::visitPathMode(GqlParser::PathModeContext* ctx,
                                           ModeType& modeType) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_RET_FAIL(byPass(ctx))) {
    ...
    switch (token_->getType()) {
      ...
      default:
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(WARNING) << "Invalid token value: "
                     << KV("token", token_->getText()) << DK(ret);
        break;
    }
  }
...
std::any GQLAstVisitor::visitQuantifiedPathPrimary(
    GqlParser::QuantifiedPathPrimaryContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_ANY_NULL(pathPrimaryCtx, patternQuantifier)) {
    ...
    if (childRes_->type() == AstNodeType::kEdge ||
        childRes_->type() == AstNodeType::kNode) {
      node = childRes_;
    } else {
      ret = GEAXErrorCode::GEAX_OOPS;
  ...
  if (GEAX_OK(ret) &&
      GEAX_RET_FAIL(VISIT_RULE_WITH_FA(patternQuantifier, node))) {
    LOG(WARNING) << "Failed to visit rule graphPatternQuantifier: " << K(ret);
  }
  return std::any();
}

std::any GQLAstVisitor::visitQuestionedPathPrimary(
    GqlParser::QuestionedPathPrimaryContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  AstNode* node = nullptr;
  DEFER(node, ret);
  ...
  IntParam lower = 0;
  if (GEAX_OK(ret) && GEAX_RET_FAIL(setEdgePatternHopRange(
                          node, std::move(lower), std::move(upper)))) {
...
std::any GQLAstVisitor::visitGqlGraphPatternAsteriskQuantifier(
  ...
  IntParam lower = 0;
  if (GEAX_RET_FAIL(
          setEdgePatternHopRange(faRes_, std::move(lower), std::move(upper)))) {
    LOG(WARNING) << "Failed to setEdgePatternHopRange: " << DK(ret);
  }
  return std::any();
}
...
std::any GQLAstVisitor::visitFixedQuantifier(
    GqlParser::FixedQuantifierContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_IS_NULL(integerCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING)
        << "integerLiteral of GqlGraphPatternFixedQuantifier is not set: "
        << K(ret);
  ...
  if (GEAX_OK(ret)) {
    if (GEAX_RET_FAIL(setEdgePatternHopRange(faRes_, std::move(lower),
                                             std::move(upper)))) {
      LOG(WARNING) << "Failed to setEdgePatternHopRange: " << DK(ret);
    }
  }
...
std::any GQLAstVisitor::visitGeneralQuantifier(
    GqlParser::GeneralQuantifierContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
...
GEAXErrorCode GQLAstVisitor::setEdgePatternHopRange(
    AstNode* fa, IntParam&& lower, std::optional<IntParam>&& upper) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_IS_NULL(fa)) {
    ...
    ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
    LOG(WARNING) << "GraphPatternQuantifier is not supported in VertexPattern: "
                 << K(ret);
...
std::any GQLAstVisitor::visitOrderByAndPageStatement(
  ...
  PrimitiveResultStatement* result = nullptr;
  // TODO(ljr) : consider use a AST node 'OrderByAndPage'? It contains
  // offset,limit and orderBy
  if (GEAX_IS_NULL(result = castAs<PrimitiveResultStatement>(
                       faRes_, AstNodeType::kPrimitiveResultStatement))) {
    ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
    LOG(WARNING) << "OrderByAndPageStatement is only supported in "
                    "primitiveResultStatement yet: "
                 << K(ret);
  } else {
    for (auto i = 0u; GEAX_OK(ret) && i < ctx->children.size(); ++i) {
      ...
      if (checkedCast(ctx->children[i], offsetCtx)) {
        ...
        if (GEAX_IS_NULL(ictx = offsetCtx->unsignedIntegerSpecification())) {
          ...
          LOG(WARNING)
              << "Failed to visit expr rule unsignedIntegerSpecification: "
              << K(ret);
        } else {
          switch (childRes_->type()) {
            case AstNodeType::kVInt: {
            ...
            default: {
              ret = GEAXErrorCode::GEAX_OOPS;
              LOG(WARNING) << "Child result should be VInt or Param: "
                           << K(ret);
              break;
            }
          }
        ...
        if (GEAX_IS_NULL(orderListCtx = orderbyCtx->sortSpecificationList())) {
          ...
          for (auto j = 0u; GEAX_OK(ret) && j < items.size(); ++j) {
            ...
            if (GEAX_IS_NULL(items[j])) {
              ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
              LOG(WARNING) << "Child of SortSpecification is not set: "
                           << K(ret);
            } else if (GEAX_RET_FAIL(VISIT_RULE(
                           items[j], AstNodeType::kOrderByField, field))) {
              LOG(WARNING) << "Failed to visit rule sortspecification: "
                           << K(ret);
            } else {
...
std::any GQLAstVisitor::visitSortSpecification(
    GqlParser::SortSpecificationContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(keyCtx = ctx->sortKey())) {
    ...
    if (GEAX_OK(ret)) {
      ...
      if (nullptr != (orderCtx = ctx->orderingSpecification())) {
        if (nullptr != (orderCtx->ASC()) ||
            nullptr != (orderCtx->ASCENDING())) {
          order = false;
        } else if (nullptr != (orderCtx->DESC()) ||
                   nullptr != (orderCtx->DESCENDING())) {
          order = true;
        }
...
std::any GQLAstVisitor::visitCallQueryStatement(
    GqlParser::CallQueryStatementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(callCtx = ctx->callProcedureStatement())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING)
        << "CallProcedureStatement is not set in rule CallQueryStatement: "
        << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_RULE(
                 callCtx, AstNodeType::kCallProcedureStatement, callStmt))) {
    LOG(WARNING) << "Failed to visit CallProcedureStatement: " << K(ret);
...
std::any GQLAstVisitor::visitCallProcedureStatement(
    GqlParser::CallProcedureStatementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  CallProcedureStatement* procedureStmt =
      ALLOC_GEAOBJECT(CallProcedureStatement);
...
std::any GQLAstVisitor::visitInlineProcedureCall(
    GqlParser::InlineProcedureCallContext* ctx) {
  childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}

std::any GQLAstVisitor::visitNamedProcedureCall(
    GqlParser::NamedProcedureCallContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitInsertPathPattern(
    GqlParser::InsertPathPatternContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  PathChain* pathChain = ALLOC_GEAOBJECT(PathChain);
  DEFER(pathChain, ret);

  Node* start = nullptr;
  std::vector<GqlParser::InsertNodePatternContext*> nodeList =
      ctx->insertNodePattern();
  std::vector<GqlParser::InsertEdgePatternContext*> edgeList =
      ctx->insertEdgePattern();
  if (GEAX_UNLIKELY(nodeList.empty())) {
    ...
    LOG(WARNING) << "InsertNodePattern is not set: " << K(ret);
                 ...
                 VISIT_RULE(nodeList[0], AstNodeType::kNode, start))) {
  ...
  for (auto i = 0u; i < edgeList.size() && GEAX_OK(ret); ++i) {
    ...
    if (GEAX_ANY_NULL(edgeList[i], nodeList[i + 1])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING) << "InsertNodePattern/InsertEdgePattern is not set in "
                      "InsertPathPattern: "
                   << KMP(edgeList[i], nodeList[i + 1]) << DKM(i, ret);
    } else if (GEAX_RET_FAIL(VISIT_RULE(edgeList[i], AstNodeType::kEdge, e))) {
      LOG(WARNING) << "Failed to visit InsertNodePattern: " << K(ret);
    } else if (GEAX_RET_FAIL(
                   VISIT_RULE(nodeList[i + 1], AstNodeType::kNode, v))) {
...
std::any GQLAstVisitor::visitInsertNodePattern(
    GqlParser::InsertNodePatternContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (nullptr == (fillerCtx = ctx->insertElementPatternFiller())) {
    ...
    v->setFiller(emptyFiller);
                 ...
                 VISIT_RULE(fillerCtx, AstNodeType::kElementFiller, filler))) {
    LOG(WARNING) << "Failed to visit InsertElementPatternFillerContext: "
                 << K(ret);
  } else {
    v->setFiller(filler);
  }
...
GEAXErrorCode GQLAstVisitor::visitInsertEdgePattern(
    ...
    GqlParser::InsertElementPatternFillerContext* fillerCtx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (nullptr == fillerCtx) {
    ...
    e->setFiller(emptyFiller);
                 ...
                 VISIT_RULE(fillerCtx, AstNodeType::kElementFiller, filler))) {
    LOG(WARNING) << "Failed to visit rule InsertElementPatternFiller: "
                 << K(ret);
  } else {
...
std::any GQLAstVisitor::visitInsertEdgePointingLeft(
    GqlParser::InsertEdgePointingLeftContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitInsertEdgePattern(
          EdgeDirection::kPointLeft, ctx->insertElementPatternFiller()))) {
...
std::any GQLAstVisitor::visitInsertEdgePointingRight(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitInsertEdgePattern(
          EdgeDirection::kPointRight, ctx->insertElementPatternFiller()))) {
    LOG(WARNING) << "Failed to visit InsertEdgePointingRight" << DK(ret);
  }
  return std::any();
}

std::any GQLAstVisitor::visitInsertEdgeUndirected(
    GqlParser::InsertEdgeUndirectedContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitInsertEdgePattern(
          EdgeDirection::kAnyDirected, ctx->insertElementPatternFiller()))) {
...
std::any GQLAstVisitor::visitInsertElementPatternFiller(
  ...
  for (auto i = 0u; i < ctx->children.size() && GEAX_OK(ret); ++i) {
    ...
    GqlParser::LabelAndPropertySetSpecificationContext* labelPropertyCtx =
        nullptr;
    if (checkedCast(ctx->children[i], varCtx)) {
      if (GEAX_RET_FAIL(VISIT_RULE_WITH_FA(varCtx, filler))) {
        LOG(WARNING) << "Failed to visit ElementVariableDeclaration: "
                     << K(ret);
      }
    } else if (checkedCast(ctx->children[i], labelPropertyCtx)) {
      if (GEAX_RET_FAIL(VISIT_RULE_WITH_FA(labelPropertyCtx, filler))) {
        LOG(WARNING) << "Failed to visit LabelAndPropertySetSpecification: "
                     << K(ret);
      }
    }
  }
...
std::any GQLAstVisitor::visitLabelAndPropertySetSpecification(
  ...
  ElementFiller* filler = nullptr;
  if (GEAX_IS_NULL(filler = castAs<ElementFiller>(
                       faRes_, AstNodeType::kElementFiller))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
  ...
  for (auto i = 0u; i < ctx->children.size() && GEAX_OK(ret); ++i) {
    ...
    if (checkedCast(ctx->children[i], labelCtx)) {
      ...
      if (GEAX_RET_FAIL(
              VISIT_RULE(propertyCtx, AstNodeType::kPropStruct, prop))) {
        LOG(WARNING) << "Failed to visit ElementPropertySpecification: "
                     << K(ret);
      } else {
...
std::any GQLAstVisitor::visitLabelSetSpecification(
    GqlParser::LabelSetSpecificationContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitElementPatternFiller(
    GqlParser::ElementPatternFillerContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ElementFiller* filler = ALLOC_GEAOBJECT(ElementFiller);
  DEFER(filler, ret);
  ...
  if (GEAX_FAIL(ret)) {
                 ...
                 visitElementPatternPredicates(predicateCtxs, filler))) {
...
std::any GQLAstVisitor::visitElementVariableDeclaration(
  ...
  if (GEAX_IS_NULL(filler = castAs<ElementFiller>(
    ...
    if (nullptr != ctx->TEMP()) {
      ...
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING)
          << "ElementVariable is not set in ElementVariableDeclaration: "
          << K(ret);
    } else {
  ...
  if (GEAX_IS_NULL(filler)) {
    ...
    for (auto i = 0u; i < predicateCtxs.size() && GEAX_OK(ret); ++i) {
      if (GEAX_UNLIKELY(predicateCtxs[i]->children.size() != 1)) {
        ...
        LOG(WARNING)
            << "Invalid children num for rule ElementPatternPredicate: "
        ...
        if (GEAX_RET_FAIL(VISIT_RULE(tableFuncCtx, AstNodeType::kTableFunction,
                                     tableFunc))) {
        ...
        ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
        LOG(WARNING)
            << "Multi WhereClause or ElementProperty is not supported yet: "
...
std::any GQLAstVisitor::visitPropertyKeyValuePairList(
  ...
  std::vector<GqlParser::PropertyKeyValuePairContext*> kvCtxs =
      ctx->propertyKeyValuePair();
  for (auto i = 0u; GEAX_OK(ret) && i < kvCtxs.size(); ++i) {
    if (GEAX_IS_NULL(kvCtxs[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING) << "Child of PropertyKeyValuePairList is not set: "
                   << K(ret);
...
std::any GQLAstVisitor::visitPropertyKeyValuePair(
    GqlParser::PropertyKeyValuePairContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  GqlParser::PropertyNameContext* nameCtx = nullptr;
  GqlParser::ExpressionContext* exprCtx = nullptr;
  if (GEAX_IS_NULL(prop =
                       castAs<PropStruct>(faRes_, AstNodeType::kPropStruct))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
...
std::any GQLAstVisitor::visitElementTableFunction(
    GqlParser::ElementTableFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  TableFunctionClause* tableFunc = ALLOC_GEAOBJECT(TableFunctionClause);
  DEFER(tableFunc, ret);

  Function* func = nullptr;
  if (GEAX_RET_FAIL(visitTableFunction(ctx->tableFunctionName(),
                                       ctx->eleTableFuncParameter()))) {
...
std::any GQLAstVisitor::visitGroupingElement(
    GqlParser::GroupingElementContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_IS_NULL(result = castAs<PrimitiveResultStatement>(
                       faRes_, AstNodeType::kPrimitiveResultStatement))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Faild to cast to node kPrimitiveResultStatement: "
                 << K(ret);
  } else if (GEAX_IS_NULL(exprCtx = ctx->expression())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
...
GEAXErrorCode GQLAstVisitor::visitFullEdgePattern(
    EdgeDirection direction,
    GqlParser::ElementPatternFillerContext* fillerCtx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  Edge* e = ALLOC_GEAOBJECT(Edge);
  DEFER(e, ret);
  ...
  if (GEAX_IS_NULL(fillerCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "ElementPatternFiller is not set in rule FullEdgePattern: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(
                 VISIT_RULE(fillerCtx, AstNodeType::kElementFiller, filler))) {
...
std::any GQLAstVisitor::visitFullEdgePointingLeft(
    GqlParser::FullEdgePointingLeftContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitFullEdgePattern(EdgeDirection::kPointLeft,
                                         ctx->elementPatternFiller()))) {
    LOG(WARNING) << "Failed to visit FullEdgePointingLeft" << DK(ret);
  }
  return std::any();
}

std::any GQLAstVisitor::visitFullEdgeUndirected(
    GqlParser::FullEdgeUndirectedContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitFullEdgePattern(EdgeDirection::kUndirected,
                                         ctx->elementPatternFiller()))) {
...
std::any GQLAstVisitor::visitFullEdgePointingRight(
    GqlParser::FullEdgePointingRightContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitFullEdgePattern(EdgeDirection::kPointRight,
                                         ctx->elementPatternFiller()))) {
...
std::any GQLAstVisitor::visitFullEdgeLeftOrUndirected(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitFullEdgePattern(EdgeDirection::kLeftOrUndirected,
                                         ctx->elementPatternFiller()))) {
...
std::any GQLAstVisitor::visitFullEdgeUndirectedOrRight(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitFullEdgePattern(EdgeDirection::kRightOrUndirected,
                                         ctx->elementPatternFiller()))) {
...
std::any GQLAstVisitor::visitFullEdgeLeftOrRight(
    GqlParser::FullEdgeLeftOrRightContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitFullEdgePattern(EdgeDirection::kLeftOrRight,
                                         ctx->elementPatternFiller()))) {
...
std::any GQLAstVisitor::visitFullEdgeAnyDirection(
    GqlParser::FullEdgeAnyDirectionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  if (GEAX_RET_FAIL(visitFullEdgePattern(EdgeDirection::kAnyDirected,
                                         ctx->elementPatternFiller()))) {
...
std::any GQLAstVisitor::visitReturnStatementBody(
    GqlParser::ReturnStatementBodyContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_IS_NULL(result = castAs<PrimitiveResultStatement>(
                       faRes_, AstNodeType::kPrimitiveResultStatement))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Failed to cast to node kPrimitiveResultStatement: "
                 << K(ret);
  }
  for (auto i = 0u; i < ctx->children.size() && GEAX_OK(ret); ++i) {
    ...
    if (hintItems == nullptr && checkedCast(ctx->children[i], hintItems)) {
    ...
    } else if (quantifier == nullptr &&
               checkedCast(ctx->children[i], quantifier)) {
      ...
      ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
      LOG(WARNING) << "RETURN * or NO BINDINGS is not supported yet: "
                   << K(ret);
    }
  }
  return std::any();
...
std::any GQLAstVisitor::visitGqlReadConsistency(
    parser::GqlParser::GqlReadConsistencyContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(identifierCtx = ctx->identifier())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Identifier is not set in rule GqlReadConsistency: "
                 << K(ret);
  } else {
...
std::any GQLAstVisitor::visitGqlAllowAnonymousTable(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  AllowAnonymousTable* allowAnonymousTable =
      ALLOC_GEAOBJECT(AllowAnonymousTable);
  ...
  if (GEAX_IS_NULL(boolCtx = ctx->unsignedBooleanSpecification())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "UnsignedBooleanSpecification is not set in rule "
                    "GqlAllowAnonymousTable: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(ACCEPT_RULE(boolCtx))) {
    LOG(WARNING) << "Failed to visit expr rule unsignedBooleanSpecification: "
                 << K(ret);
  } else {
    switch (childRes_->type()) {
...
std::any GQLAstVisitor::visitGqlEdgeOnJoin(
    parser::GqlParser::GqlEdgeOnJoinContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_UNLIKELY(identifierCtx.size() != 2)) {
    ...
    LOG(WARNING) << "Failed to get two identifiers in rule GqlEdgeOnJoin: "
                 << K(ret);
...
std::any GQLAstVisitor::visitReturnItemList(
    GqlParser::ReturnItemListContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  PrimitiveResultStatement* result = nullptr;
  if (GEAX_IS_NULL(result = castAs<PrimitiveResultStatement>(
                       faRes_, AstNodeType::kPrimitiveResultStatement))) {
...
std::any GQLAstVisitor::visitSelectStatement(
  ...
  for (auto i = 1u; i < ctx->children.size() && GEAX_OK(ret); ++i) {
    ...
    } else if (selectItems == nullptr &&
               checkedCast(ctx->children[i], selectItems)) {
      if (GEAX_RET_FAIL(VISIT_RULE_WITH_FA(selectItems, result))) {
        LOG(WARNING) << "Failed to visit rule ReturnItemList: " << K(ret);
      }
    } else if (selectBody == nullptr &&
               checkedCast(ctx->children[i], selectBody)) {
...
std::any GQLAstVisitor::visitSelectItemList(
    GqlParser::SelectItemListContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  PrimitiveResultStatement* result = nullptr;
  if (GEAX_IS_NULL(result = castAs<PrimitiveResultStatement>(
                       faRes_, AstNodeType::kPrimitiveResultStatement))) {
...
std::any GQLAstVisitor::visitSelectStatementBody(
    GqlParser::SelectStatementBodyContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  MatchStatement* match = nullptr;
  if (GEAX_IS_NULL(selectStmt = castAs<SelectStatement>(
                       faRes_, AstNodeType::kSelectStatement))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    ...
    LOG(WARNING) << "MatchStatement is not set in SelectStatement :" << K(ret);
                 ...
                 VISIT_RULE(matchCtx, AstNodeType::kMatchStatement, match))) {
...
std::any GQLAstVisitor::visitBindingVariable(
    GqlParser::BindingVariableContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitGqlNotExpression(
    GqlParser::GqlNotExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitGqlLogicalOrExpression(
    GqlParser::GqlLogicalOrExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitGqlBooleanTestExpression(
  ...
  for (auto i = 0u; GEAX_OK(ret) && i < ctx->children.size(); ++i) {
    if (GEAX_IS_NULL(ctx->children[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(ERROR) << "Child is not set for rule GqlBooleanTestExpression: "
                 << K(ret);
    } else if (ctx->children[i]->getTreeType() ==
      ...
      if (GEAX_UNLIKELY(!uncheckedCast(ctx->children[i], rule))) {
        ...
        if (GEAX_RET_FAIL(VISIT_EXPR(rule, expr))) {
          LOG(WARNING) << "Failed to visit rule ExpressionPredicate: "
                       << K(ret);
        }
      } else if (GEAX_RET_FAIL(byPass(rule))) {  // truthValue
        LOG(WARNING) << "Failed to visit children of rule truthValue: "
                     << K(ret);
        ...
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(WARNING) << "Invalid token value: "
                     << KV("token", token_->getType()) << DK(ret);
      }
    } else if (ctx->children[i]->getTreeType() ==
...
std::any GQLAstVisitor::visitGqlBitXorExpression(
    GqlParser::GqlBitXorExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitGqlBitShiftExpression(
    GqlParser::GqlBitShiftExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitGqlBitAndExpression(
    GqlParser::GqlBitAndExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitGqlBitOrExpression(
    GqlParser::GqlBitOrExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(ctx->op)) {
    ...
    switch (ctx->op->getType()) {
      ...
      default:
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(WARNING) << "Invalid token value: "
                     << KV("token", ctx->op->getType()) << DK(ret);
        break;
    }

    if (GEAX_OK(ret) &&
        GEAX_RET_FAIL(visitBinaryExpr(ctx->lhs, ctx->rhs, exprNode))) {
...
std::any GQLAstVisitor::visitGqlComparisonExpression(
  ...
  if (GEAX_ANY_NULL(ctx->lhs, ctx->rhs, compCtx)) {
    ...
    switch (token_->getType()) {
      ...
      default:
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(ERROR) << "Invalid token type: " << KV("token", token_->getText())
                   << DK(ret);
        break;
    }
  }
...
std::any GQLAstVisitor::visitGqlInExpression(
    GqlParser::GqlInExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_ANY_NULL(exprCtx, listCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of GqlInExpression is not set "
                 << KMP(exprCtx, listCtx) << DK(ret);
...
std::any GQLAstVisitor::visitGqlLikeExpression(
    GqlParser::GqlLikeExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_ANY_NULL(ctx->self, ctx->regex)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of GqlLikeExpression is not set "
                 << KMP(ctx->self, ctx->regex) << DK(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(ctx->self, selfExprNode))) {
    LOG(WARNING) << "Fail to visit self children of rule GqlLikeExpression"
                 << DK(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(ctx->regex, regexExprNode))) {
    LOG(WARNING) << "Fail to visit regex children of rule GqlLikeExpression"
                 << DK(ret);
  } else {
...
std::any GQLAstVisitor::visitGqlBetweenExpression(
    GqlParser::GqlBetweenExpressionContext* ctx) {
  // childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}

std::any GQLAstVisitor::visitGqlExistsExpression(
    GqlParser::GqlExistsExpressionContext* ctx) {
  // childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}

std::any GQLAstVisitor::visitGqlNullExpression(
    GqlParser::GqlNullExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_ANY_NULL(expr, nullCond)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of GqlNullExpression is not set "
                 << KMP(expr, nullCond) << DK(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(expr, exprNode))) {
    LOG(WARNING) << "Fail to visit expressionPredicate children of rule "
                    "GqlNullExpression"
                 << DK(ret);
  } else {
...
std::any GQLAstVisitor::visitGqlNormalizedExpression(
  ...
  if (GEAX_ANY_NULL(expr, normalizedCond)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of GqlNormalizedExpression is not set "
                 << KMP(expr, normalizedCond) << DK(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(expr, exprNode))) {
    LOG(WARNING) << "Fail to visit expressionAtom children of rule "
                    "GqlNormalizedExpression"
                 << DK(ret);
  } else {
...
std::any GQLAstVisitor::visitGqlDirectedExpression(
    GqlParser::GqlDirectedExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_ANY_NULL(eleRef, directedCond)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of GqlDirectedExpression is not set "
                 << KMP(eleRef, directedCond) << DK(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(eleRef, ref))) {
    LOG(WARNING) << "Fail to visit elementReference children of rule "
                    "GqlDirectedExpression"
                 << DK(ret);
  } else {
...
std::any GQLAstVisitor::visitGqlLabeledExpression(
    GqlParser::GqlLabeledExpressionContext* ctx) {
  // childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}
...
std::any GQLAstVisitor::visitGqlSameExpression(
    GqlParser::GqlSameExpressionContext* ctx) {
  // childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}

std::any GQLAstVisitor::visitGqlUnaryExpression(
    GqlParser::GqlUnaryExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_ANY_NULL(atomCtx, unaryOpCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of GqlUnaryExpression is not set "
                 << KMP(atomCtx, unaryOpCtx) << DK(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(atomCtx, exprNode))) {
    LOG(WARNING) << "Fail to visit children of rule GqlUnaryExpression"
                 << DK(ret);
    ...
    switch (token) {
      ...
      default: {
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(WARNING) << "Invalid unaryOperator token type: "
                     << KV("token", token) << K(ret);
        break;
      }
    }
  }
...
std::any GQLAstVisitor::visitLabelExpression(
    GqlParser::LabelExpressionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  LabelTree* labelTree = nullptr;
  DEFER(labelTree, ret);
...
std::any GQLAstVisitor::visitIntegerLiteral(
    GqlParser::IntegerLiteralContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  VInt* i = ALLOC_GEAOBJECT(VInt);
  DEFER(i, ret);
  if (ctx->UNSIGNED_OCTAL_INTEGER() != nullptr) {
    i->setVal(
        std::strtoll(ctx->getText().replace(0, 2, "0").c_str(), nullptr, 8));
...
std::any GQLAstVisitor::visitBooleanLiteral(
    GqlParser::BooleanLiteralContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitCharacterStringLiteral(
    GqlParser::CharacterStringLiteralContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitByteStringLiteral(
    GqlParser::ByteStringLiteralContext* ctx) {
  childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}
...
std::any GQLAstVisitor::visitDatetimeLiteral(
    GqlParser::DatetimeLiteralContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(strCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Datetime string is not set for rule DateTimeLiteral: "
                 << K(ret);
  } else {
    std::string str = strCtx->getText();
    // strCtx->getText() need to remove the quotes
...
std::any GQLAstVisitor::visitTimeLiteral(GqlParser::TimeLiteralContext* ctx) {
  ...
  if (GEAX_IS_NULL(strCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Datetime string is not set for rule TimeLiteral: "
                 << K(ret);
  } else {
    std::string str = strCtx->getText();
    // strCtx->getText() need to remove the quotes
...
std::any GQLAstVisitor::visitListLiteral(GqlParser::ListLiteralContext* ctx) {
  ...
  DEFER(l, ret);
  std::vector<GqlParser::GeneralLiteralContext*> literalCtxs =
      ctx->generalLiteral();
...
std::any GQLAstVisitor::visitMapLiteral(GqlParser::MapLiteralContext* ctx) {
  ...
  std::vector<GqlParser::MapElementLiteralContext*> eleCtxs =
      ctx->mapElementLiteral();
  for (auto i = 0u; GEAX_OK(ret) && i < eleCtxs.size(); ++i) {
    Expr* k = nullptr;
    Expr* v = nullptr;
    if (GEAX_IS_NULL(eleCtxs[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING) << "MapElementLiteral is not set for rule MapLiteral: "
                   << K(ret);
      ...
      LOG(WARNING) << "Failed to visit key expr in MapElementLiteral: "
                   << K(ret);
    } else if (GEAX_RET_FAIL(VISIT_EXPR(eleCtxs[i]->value, v))) {
      LOG(WARNING) << "Failed to visit value expr in MapElementLiteral: "
                   << K(ret);
    } else {
      map->appendElem(k, v);
    }
...
std::any GQLAstVisitor::visitRecordLiteral(
    GqlParser::RecordLiteralContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  MkRecord* record = ALLOC_GEAOBJECT(MkRecord);
  DEFER(record, ret);

  std::vector<GqlParser::RecordFieldLiteralContext*> fieldCtxs =
      ctx->recordFieldLiteral();
  for (auto i = 0u; GEAX_OK(ret) && i < fieldCtxs.size(); ++i) {
    ...
    if (GEAX_IS_NULL(fieldCtxs[i])) {
      ...
      LOG(WARNING) << "Failed to visit value expr in RecordFieldLiteral: "
                   << K(ret);
    } else {
...
std::any GQLAstVisitor::visitDurationLiteral(
    GqlParser::DurationLiteralContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(strCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Duration string is not set for rule DurationLiteral: "
                 << K(ret);
  } else {
    std::string str = strCtx->getText();
    // strCtx->getText() need to remove the quotes
...
std::any GQLAstVisitor::visitListValueConstructor(
    GqlParser::ListValueConstructorContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  MkList* l = ALLOC_GEAOBJECT(MkList);
  DEFER(l, ret);
...
std::any GQLAstVisitor::visitMapValueConstructor(
    GqlParser::MapValueConstructorContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  MkMap* map = ALLOC_GEAOBJECT(MkMap);
  DEFER(map, ret);
  ...
  for (auto i = 0u; GEAX_OK(ret) && i < eleCtxs.size(); ++i) {
    ...
    if (GEAX_IS_NULL(eleCtxs[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING) << "MapElement is not set for rule MapConstructor: "
                   << K(ret);
    } else if (GEAX_ANY_NULL(eleCtxs[i]->key, eleCtxs[i]->value)) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
...
std::any GQLAstVisitor::visitRecordValueConstructor(
    GqlParser::RecordValueConstructorContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  MkRecord* record = ALLOC_GEAOBJECT(MkRecord);
  DEFER(record, ret);
...
std::any GQLAstVisitor::visitGqlCountAllFunction(
    GqlParser::GqlCountAllFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitGqlCountDistinctFunction(
  ...
  for (auto i = 0u; GEAX_OK(ret) && i < exprCtxs.size(); ++i) {
    ...
    if (GEAX_IS_NULL(exprCtxs[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING) << "Child of GqlCountDistinctFunction is not set: "
                   << K(ret);
...
std::any GQLAstVisitor::visitGqlGeneralSetFunction(
    GqlParser::GqlGeneralSetFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  AggFunc* agg = ALLOC_GEAOBJECT(AggFunc);
  DEFER(agg, ret);

  GqlParser::GeneralSetFunctionTypeContext* fnCtx =
      ctx->generalSetFunctionType();
...
std::any GQLAstVisitor::visitGqlBinarySetFunction(
    GqlParser::GqlBinarySetFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(typeCtx = ctx->binarySetFunctionType())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING)
        << "binarySetFunctionType is not set in rule GqlBinarySetFunction: "
        << K(ret);
  } else if (size_t token = 0; GEAX_RET_FAIL(VISIT_TOKEN(typeCtx, token))) {
    LOG(WARNING) << "Failed to visit token rule binarySetFunctionType: "
                 << K(ret);
  } else {
    switch (token) {
      ...
      default:
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(WARNING) << "Invalid token type: " << KV("token", token_->getType())
                     << K(ret);
        break;
    }
  }
...
std::any GQLAstVisitor::visitGqlWindowFunction(
    GqlParser::GqlWindowFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (nullptr != (generalCtx = ctx->generalSetFunctionType())) {
    AggFunc* agg = ALLOC_GEAOBJECT(AggFunc);
    if (GEAX_RET_FAIL(visitAggExpr(generalCtx, ctx->setQuantifier(),
                                   ctx->expression(), agg))) {
      LOG(WARNING) << "Failed to visit AggExpr: " << K(ret);
    } else {
      window->setExpr(agg);
    ...
    if (nullptr != ctx->expression() || nullptr != ctx->setQuantifier()) {
      ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
      LOG(WARNING)
          << "SetQuantifier/Expression is not supported in WindowFunctionType: "
          << K(ret);
...
std::any GQLAstVisitor::visitWindowClause(GqlParser::WindowClauseContext* ctx) {
  ...
  if (GEAX_IS_NULL(window =
                       castAs<Windowing>(faRes_, AstNodeType::kWindowing))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Failed to cast to node Windowing: " << K(ret);
  } else {
    std::vector<GqlParser::ExpressionAtomContext*> exprCtxs =
        ctx->expressionAtom();
    for (auto i = 0u; GEAX_OK(ret) && i < exprCtxs.size(); ++i) {
      Expr* expr = nullptr;
      if (GEAX_IS_NULL(exprCtxs[i])) {
  ...
  if (GEAX_FAIL(ret)) {
    ...
    for (auto i = 0u; GEAX_OK(ret) && i < sortCtxs.size(); ++i) {
      ...
      if (GEAX_IS_NULL(sortCtxs[i])) {
        ...
        ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
        LOG(WARNING) << "NullOrdering is not supported in WindowClause: "
                     << K(ret);
...
GEAXErrorCode GQLAstVisitor::visitAggExpr(
    GqlParser::GeneralSetFunctionTypeContext* typeCtx,
  ...
  if (GEAX_ANY_NULL(typeCtx, exprCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "SetFunctionType/Expression of rule GqlGeneralSetFunction "
                    "is not set: "
  ...
  } else if (size_t token = 0;
             GEAX_RET_FAIL(VISIT_TOKEN(quantifierCtx, token))) {
    LOG(WARNING) << "Failed to visit token SetQuantifier: " << K(ret);
  } else {
    switch (token) {
      case GqlParser::DISTINCT:
...
std::any GQLAstVisitor::visitGqlDistinctInGeneralFunction(
  ...
  if (GEAX_UNLIKELY(exprCtxs.size() < 2)) {
    ret = GEAXErrorCode::GEAX_OOPS;
    LOG(WARNING)
        << "Num mismatch, expected greater than 2 parameters but actually "
        << KV("size", exprCtxs.size()) << DK(ret);
  } else if (GEAX_IS_NULL(exprCtxs[0])) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING)
        << "Expression of rule GqlDistinctInGeneralFunction is not set: "
        << K(ret);
  } else {
    GqlParser::GeneralSetFunctionTypeContext* fnCtx =
        ctx->generalSetFunctionType();
...
std::any GQLAstVisitor::visitGqlOneArgScalarFunction(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  if (GEAX_RET_FAIL(visitFunction(ctx->oneArgNumericFunctionName(),
...
std::any GQLAstVisitor::visitGqlTwoArgScalarFunction(
  ...
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  if (GEAX_RET_FAIL(visitFunction(ctx->twoArgNumericFunctionName(),
                                  ctx->functionParameter()))) {
...
std::any GQLAstVisitor::visitGqlIfFunction(
    GqlParser::GqlIfFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
...
std::any GQLAstVisitor::visitGeneralFunction(
    GqlParser::GeneralFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  if (GEAX_RET_FAIL(
          visitFunction(ctx->functionName(), ctx->functionParameter()))) {
    LOG(WARNING) << "Failed to visit rule GeneralFunction: " << K(ret);
  }
  return std::any();
}

std::any GQLAstVisitor::visitGqlListTrimFunction(
    GqlParser::GqlListTrimFunctionContext* ctx) {
  childRet_ = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
  return std::any();
}
...
std::any GQLAstVisitor::visitGqlSubstringFunction(
    GqlParser::GqlSubstringFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  Function* func = ALLOC_GEAOBJECT(Function);
  DEFER(func, ret);
...
std::any GQLAstVisitor::visitGqlFoldStringFunction(
    GqlParser::GqlFoldStringFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  Function* func = ALLOC_GEAOBJECT(Function);
  DEFER(func, ret);
  ...
  if (GEAX_IS_NULL(exprCtx = ctx->expressionAtom())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "ExpressionAtom is not set in rule GqlFoldStringFunction: "
                 << K(ret);
...
std::any GQLAstVisitor::visitGqlSingleTrimStringFunction(
  ...
  std::vector<GqlParser::ExpressionAtomContext*> exprCtxs =
      ctx->expressionAtom();
  if (nullptr != ctx->FROM() || nullptr != ctx->trimSpecification() ||
      exprCtxs.size() != 1) {
    ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
    LOG(WARNING) << "TrimSpecification is not supported yet: " << K(ret);
  } else if (GEAX_IS_NULL(ctx->trimSrc)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "trimSrc is not set in rule GqlTrimStringFunction: "
                 << K(ret);
...
// TODO(boyao.zby) we only support n.a currently, more complicated cases should
// be supported.
std::any GQLAstVisitor::visitPropertyReference(
    GqlParser::PropertyReferenceContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_ANY_NULL(varCtx, propCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Child of rule PropertyReference is not set: "
                 << KMP(varCtx, propCtx) << DK(ret);
...
std::any GQLAstVisitor::visitGqlNullIfCaseFunction(
    GqlParser::GqlNullIfCaseFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  Function* func = ALLOC_GEAOBJECT(Function);
  DEFER(func, ret);
  ...
  if (GEAX_ANY_NULL(ctx->lhs, ctx->rhs)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Children of GqlNullIfExpression is not set: "
                 << KMP(ctx->lhs, ctx->rhs) << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(ctx->lhs, lhs))) {
...
std::any GQLAstVisitor::visitGqlCoalesceCaseFunction(
  ...
  for (auto i = 0u; i < exprCtxs.size() && GEAX_OK(ret); ++i) {
    ...
    if (GEAX_IS_NULL(exprCtxs[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING) << "Expression is not set in rule GqlCoalesceExpression: "
                   << K(ret);
    } else if (GEAX_RET_FAIL(VISIT_EXPR(exprCtxs[i], expr))) {
      LOG(WARNING) << "Failed to visit expr: " << K(ret);
    } else {
...
std::any GQLAstVisitor::visitGqlSimpleCaseFunction(
    GqlParser::GqlSimpleCaseFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  ...
  if (GEAX_IS_NULL(exprCtx = ctx->expressionAtom())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Expression of GqlSimpleCaseFunction is not set: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(exprCtx, condNode))) {
    LOG(WARNING) << "Failed to visit expr of rule GqlSimpleCaseFunction: "
                 << K(ret);
  } else {
  ...
  if (GEAX_OK(ret) && nullptr != (elseCtx = ctx->elseClause())) {
    ...
    if (GEAX_RET_FAIL(VISIT_EXPR(elseCtx, elseNode))) {
      LOG(WARNING)
          << "Failed to visit else expr of rule GqlSimpleCaseFunction: "
          << K(ret);
    } else {
  ...
  if (GEAX_OK(ret)) {
    ...
    for (auto i = 0u; i < whenClauses.size() && GEAX_OK(ret); ++i) {
      ...
      std::vector<GqlParser::WhenOperandContext*> whenOps =
          whenClauses[i]->whenOperand();
      ...
      if (GEAX_IS_NULL(thenExpr = whenClauses[i]->expression())) {
        ...
        LOG(WARNING) << "Failed to visit then expr of rule SimpleWhenClause: "
                     << K(ret);
      }
      for (auto j = 0u; j < whenOps.size() && GEAX_OK(ret); ++j) {
        ...
        if (GEAX_IS_NULL(whenOp)) {
          ...
          // Other: Comparision/null/directed/labeled/source/destination
          // predicate The old gql case expr does not support these types, so
          // here is unsupported.
          ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
          LOG(WARNING) << "Unsupported WhenOperand: "
                       << KV("content", whenOp->children[0]->getText())
                       << DK(ret);
...
std::any GQLAstVisitor::visitGqlSearchedCaseFunction(
  ...
  if (nullptr != (elseCtx = ctx->elseClause())) {
    ...
    if (GEAX_RET_FAIL(VISIT_EXPR(elseCtx, elseNode))) {
      LOG(WARNING)
          << "Failed to visit else expr of rule GqlSearchedCaseFunction: "
          << K(ret);
    } else {
      caseNode->setElseBody(elseNode);
    }
  ...
  if (GEAX_OK(ret)) {
    ...
    Expr* whenNode{nullptr};
    Expr* thenNode{nullptr};
    std::vector<GqlParser::SearchedWhenClauseContext*> whenExprs =
        ctx->searchedWhenClause();
    for (auto i = 0u; i < whenExprs.size() && GEAX_OK(ret); ++i) {
      if (GEAX_IS_NULL(whenExprs[i])) {
        ...
        ret = GEAXErrorCode::GEAX_OOPS;
        LOG(WARNING) << "Expr of rule SearchedWhenClause should be 2: "
                     << K(ret);
      } else {
        ...
        if (GEAX_ANY_NULL(whenExpr, thenExpr)) {
          ...
          LOG(WARNING)
              << "Failed to visit when expr of rule SearchedWhenClause: "
              << K(ret);
        } else if (GEAX_RET_FAIL(VISIT_EXPR(thenExpr, thenNode))) {
          LOG(WARNING)
              << "Failed to visit then expr of rule SearchedWhenClause: "
              << K(ret);
        } else {
          caseNode->appendCaseBody(whenNode, thenNode);
        }
...
std::any GQLAstVisitor::visitCastFunction(GqlParser::CastFunctionContext* ctx) {
  ...
  if (GEAX_ANY_NULL(exprCtx, typeCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "expr/type is not set in rule castFunction: "
                 << KMP(exprCtx, typeCtx) << DK(ret);
  } else if (GEAX_RET_FAIL(VISIT_EXPR(exprCtx, expr))) {
    LOG(WARNING) << "Failed to visit expr: " << K(ret);
  } else if (GEAX_RET_FAIL(byPass(typeCtx))) {
    LOG(WARNING) << "Failed to visit children of rule PredefinedType: "
                 << K(ret);
  } else if (GEAX_RET_FAIL(checkTokenResult())) {
    LOG(WARNING) << "Failed to check token result: " << K(ret);
  } else {
...
std::any GQLAstVisitor::visitElementFunction(
    GqlParser::ElementFunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_ANY_NULL(funcName, varCtx)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "funcName/variable is not set in rule ElementFunction: "
                 << K(ret);
    ...
    switch (token) {
      ...
      case GqlParser::ELEMENT_ID:
        ret = GEAXErrorCode::GEAX_COMMON_NOT_SUPPORT;
        LOG(WARNING) << "Unsupported function: "
                     << KV("token", token_->getText()) << DK(ret);
        break;
      default:
        ret = GEAXErrorCode::GEAX_OOPS;
...
std::any GQLAstVisitor::visitQueryConjunction(
    GqlParser::QueryConjunctionContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  QueryConjunctionType* type = nullptr;
  DEFER(type, ret);
...
std::any GQLAstVisitor::visitGqlPropertyReference(
    GqlParser::GqlPropertyReferenceContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  GetField* getField = ALLOC_GEAOBJECT(GetField);
  DEFER(getField, ret);
  ...
  if (GEAX_IS_NULL(atomCtx = ctx->expressionAtom())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "ExpressionAtom is not set in GqlPropertyReference: "
                 << K(ret);
  } else if (GEAX_IS_NULL(propCtx = ctx->propertyName())) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "PropertyName is not set in GqlPropertyReference: "
                 << K(ret);
...
GEAXErrorCode GQLAstVisitor::visitBinaryExpr(antlr4::ParserRuleContext* lhs,
  ...
  if (GEAX_ANY_NULL(lhs, rhs, fa)) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
    LOG(WARNING) << "Children is not set for binary expression: "
                 << KMP(lhs, rhs, fa) << DK(ret);
...
GEAXErrorCode GQLAstVisitor::visitListExpr(
    std::vector<GqlParser::ExpressionContext*>& exprCtxs, MkList* list) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  for (auto i = 0u; GEAX_OK(ret) && i < exprCtxs.size(); ++i) {
    Expr* expr = nullptr;
    if (GEAX_IS_NULL(exprCtxs[i])) {
      ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
      LOG(WARNING)
          << "Expression is not set for rule ListConstructor/ListValue: "
          << K(ret);
    } else if (GEAX_RET_FAIL(VISIT_EXPR(exprCtxs[i], expr))) {
      LOG(WARNING) << "Failed to visit expr rule: " << K(ret);
    } else {
...
std::string GQLAstVisitor::getFullText(
...
std::any GQLAstVisitor::visitRemoveStatement(
  ...
  if (GEAX_IS_NULL(removeItemListCtx = ctx->removeItemList())) {
    ...
    std::vector<GqlParser::RemoveItemContext*> removeItemCtxVec =
        removeItemListCtx->removeItem();
    for (size_t i = 0; GEAX_OK(ret) && i < removeItemCtxVec.size(); ++i) {
      if (GEAX_IS_NULL(removeItemCtxVec[i])) {
        ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
        LOG(WARNING) << "SetItem is not set in SetStatement: " << K(ret);
      } else if (GEAX_RET_FAIL(VISIT_RULE_WITH_FA(removeItemCtxVec[i],
                                                  removeStatement))) {
        LOG(WARNING) << "Failed to visit setItem: " << K(ret);
      }
    }
...
std::any GQLAstVisitor::visitRemovePropertyItem(
    GqlParser::RemovePropertyItemContext* ctx) {
  auto ret = GEAXErrorCode::GEAX_SUCCEED;
  DEFER_RET(ret);
  ...
  if (GEAX_IS_NULL(removeStatement = castAs<RemoveStatement>(
                       faRes_, AstNodeType::kRemoveStatement))) {
    ret = GEAXErrorCode::GEAX_COMMON_NULLPTR;
