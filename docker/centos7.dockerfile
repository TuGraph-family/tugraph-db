...
RUN yum -y install devtoolset-10 devtoolset-10-libasan-devel devtoolset-10-libstdc++-devel openssl-static git procps iproute findutils tar wget which autoconf automake libtool
